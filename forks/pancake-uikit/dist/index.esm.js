...
const Icon$1l = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M8.71005 12.29L11.3001 9.69997C11.6901 9.30997 12.3201 9.30997 12.7101 9.69997L15.3001 12.29C15.9301 12.92 15.4801 14 14.5901 14H9.41005C8.52005 14 8.08005 12.92 8.71005 12.29Z',
    })
  )
}
...
const Icon$1k = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M5 13H16.17L11.29 17.88C10.9 18.27 10.9 18.91 11.29 19.3C11.68 19.69 12.31 19.69 12.7 19.3L19.29 12.71C19.68 12.32 19.68 11.69 19.29 11.3L12.71 4.7C12.32 4.31 11.69 4.31 11.3 4.7C10.91 5.09 10.91 5.72 11.3 6.11L16.17 11H5C4.45 11 4 11.45 4 12C4 12.55 4.45 13 5 13Z',
    })
  )
}
...
const Icon$1g = function (props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('path', {
        d:
          'M68.25 36C68.25 53.8112 53.8112 68.25 36 68.25C18.1888 68.25 3.75 53.8112 3.75 36C3.75 18.1888 18.1888 3.75 36 3.75C53.8112 3.75 68.25 18.1888 68.25 36Z',
        fill: '#C4C4C4',
      })
    ),
    React.createElement(
      ...
      React.createElement('path', {
        d:
          'M60.8932 62.3221C60.8932 70.8173 49.624 77.704 35.7228 77.704C21.8216 77.704 10.5525 70.8173 10.5525 62.3221V58.4067H60.8932V62.3221Z',
        fill: primaryColor,
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
        clipRule: 'evenodd',
        d:
          'M26.9995 32.4051C27.637 28.733 24.7711 25.4083 21.0489 25.5019C17.7797 25.5842 15.1821 28.3013 15.247 31.5709L15.5874 48.7245C15.5903 48.8687 15.6002 49.0111 15.617 49.1513C12.4376 51.7266 10.5525 54.9321 10.5525 58.4066C10.5525 66.9018 21.8216 73.7885 35.7228 73.7885C49.624 73.7885 60.8932 66.9018 60.8932 58.4066C60.8932 53.5752 57.2481 49.264 51.5468 46.444L60.0445 38.2879C62.7358 35.7048 62.3504 31.2956 59.252 29.2185C56.5714 27.4215 52.9416 28.1378 51.1446 30.8184L43.2742 42.5588C43.0458 42.8994 42.8724 43.2609 42.7519 43.6326C40.521 43.2369 38.1625 43.0248 35.7228 43.0248C31.8473 43.0248 28.1763 43.56 24.897 44.5162L26.9995 32.4051Z',
        fill: primaryColor,
      }),
      React.createElement('path', {
        d:
          'M32.0873 57.2881C32.0873 59.6049 30.8352 61.4831 29.2906 61.4831C27.746 61.4831 26.4939 59.6049 26.4939 57.2881C26.4939 54.9712 27.746 53.093 29.2906 53.093C30.8352 53.093 32.0873 54.9712 32.0873 57.2881Z',
        fill: secondaryColor,
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
        clipRule: 'evenodd',
        d:
          'M28.891 54.0353C29.461 54.8903 29.8499 56.1359 29.8499 57.5677C29.8499 58.1855 30.3508 58.6864 30.9686 58.6864C31.5864 58.6864 32.0873 58.1855 32.0873 57.5677C32.0873 55.7558 31.5997 54.0649 30.7526 52.7943C29.9107 51.5314 28.6248 50.5759 27.0532 50.5759C25.4816 50.5759 24.1957 51.5314 23.3538 52.7943C22.5067 54.0649 22.0191 55.7558 22.0191 57.5677C22.0191 58.55 22.1622 59.4908 22.4244 60.3463C22.6055 60.937 23.2311 61.2691 23.8218 61.088C24.4125 60.9069 24.7446 60.2813 24.5635 59.6906C24.3685 59.0543 24.2565 58.3349 24.2565 57.5677C24.2565 56.1359 24.6454 54.8903 25.2154 54.0353C25.7906 53.1725 26.4624 52.8133 27.0532 52.8133C27.644 52.8133 28.3158 53.1725 28.891 54.0353Z',
        fill: secondaryColor,
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
...
const Icon$1f = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M12.0967 17.8521L7.87565 20.2891C6.91907 20.8414 5.69589 20.5136 5.1436 19.557L0.999729 12.3796C0.447444 11.4231 0.775193 10.1999 1.73178 9.64759L6.31754 7C6.53486 6.87453 6.76593 6.79448 6.99977 6.75691V6C6.99977 4.89543 7.8952 4 8.99977 4H14.9998C16.1043 4 16.9998 4.89543 16.9998 6V6.73545C17.299 6.75379 17.5986 6.83993 17.8759 7L22.4616 9.64759C23.4182 10.1999 23.746 11.4231 23.1937 12.3796L19.0498 19.557C18.4975 20.5136 17.2743 20.8414 16.3178 20.2891L12.0967 17.8521ZM8.99977 6L14.9998 6L14.9998 7.98154L11.2363 14.5H8.99977L8.99977 6ZM6.99977 14.5L6.99977 8.91551L2.73178 11.3796L6.87565 18.557L10.4386 16.5H8.99977C7.8952 16.5 6.99977 15.6046 6.99977 14.5ZM16.8759 8.73205L21.4616 11.3796L17.3178 18.557L12.732 15.9094L16.8759 8.73205Z',
    })
  )
}
...
const Icon$1b = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M5 7C5 6.44772 4.55228 6 4 6C3.44772 6 3 6.44772 3 7V18C3 19.1046 3.89543 20 5 20H20C20.5523 20 21 19.5523 21 19C21 18.4477 20.5523 18 20 18H5V7Z',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M19 17H7C6.44772 17 6 16.5523 6 16V12C6 11.4477 6.44772 11 7 11H10V10C10 9.44772 10.4477 9 11 9H14V7C14 6.44772 14.4477 6 15 6H19C19.5523 6 20 6.44772 20 7V16C20 16.5523 19.5523 17 19 17ZM16 8H18V15H16V8ZM12 15H14V11H12V15ZM10 13H8V15H10V13Z',
    })
  )
}
...
const Icon$1a = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M9.00012 16.2L5.50012 12.7C5.11012 12.31 4.49012 12.31 4.10012 12.7C3.71012 13.09 3.71012 13.71 4.10012 14.1L8.29012 18.29C8.68012 18.68 9.31012 18.68 9.70012 18.29L20.3001 7.70001C20.6901 7.31001 20.6901 6.69001 20.3001 6.30001C19.9101 5.91001 19.2901 5.91001 18.9001 6.30001L9.00012 16.2Z',
    })
  )
}
...
const Icon$18 = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M14.71 15.88L10.83 12L14.71 8.12001C15.1 7.73001 15.1 7.10001 14.71 6.71001C14.32 6.32001 13.69 6.32001 13.3 6.71001L8.70998 11.3C8.31998 11.69 8.31998 12.32 8.70998 12.71L13.3 17.3C13.69 17.69 14.32 17.69 14.71 17.3C15.09 16.91 15.1 16.27 14.71 15.88Z',
    })
  )
}
...
const Icon$16 = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M8.11997 14.7101L12 10.8301L15.88 14.7101C16.27 15.1001 16.9 15.1001 17.29 14.7101C17.68 14.3201 17.68 13.6901 17.29 13.3001L12.7 8.7101C12.31 8.3201 11.68 8.3201 11.29 8.7101L6.69997 13.3001C6.30997 13.6901 6.30997 14.3201 6.69997 14.7101C7.08997 15.0901 7.72997 15.1001 8.11997 14.7101Z',
    })
  )
}
...
const Icon$13 = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M12 12.75C13.63 12.75 15.07 13.14 16.24 13.65C17.32 14.13 18 15.21 18 16.38V17C18 17.55 17.55 18 17 18H7C6.45 18 6 17.55 6 17V16.39C6 15.21 6.68 14.13 7.76 13.66C8.93 13.14 10.37 12.75 12 12.75ZM4 13C5.1 13 6 12.1 6 11C6 9.9 5.1 9 4 9C2.9 9 2 9.9 2 11C2 12.1 2.9 13 4 13ZM5.13 14.1C4.76 14.04 4.39 14 4 14C3.01 14 2.07 14.21 1.22 14.58C0.48 14.9 0 15.62 0 16.43V17C0 17.55 0.45 18 1 18H4.5V16.39C4.5 15.56 4.73 14.78 5.13 14.1ZM20 13C21.1 13 22 12.1 22 11C22 9.9 21.1 9 20 9C18.9 9 18 9.9 18 11C18 12.1 18.9 13 20 13ZM24 16.43C24 15.62 23.52 14.9 22.78 14.58C21.93 14.21 20.99 14 20 14C19.61 14 19.24 14.04 18.87 14.1C19.27 14.78 19.5 15.56 19.5 16.39V18H23C23.55 18 24 17.55 24 17V16.43ZM12 6C13.66 6 15 7.34 15 9C15 10.66 13.66 12 12 12C10.34 12 9 10.66 9 9C9 7.34 10.34 6 12 6Z',
    })
  )
}
...
const Icon$11 = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M15.6772 2.8668C15.9878 1.97095 15.2658 1.05469 14.2495 1.05469C13.4213 1.05469 12.75 1.67612 12.75 2.4427L12.75 5.07933C12.75 5.61801 13.2217 6.05469 13.8037 6.05469C14.2615 6.05469 14.667 5.78094 14.8069 5.37734L15.6772 2.8668Z',
      fill: '#FFC700',
    }),
    React.createElement('path', {
      d:
        'M9.32279 2.8668C9.01225 1.97095 9.73416 1.05469 10.7505 1.05469C11.5787 1.05469 12.25 1.67612 12.25 2.4427L12.25 5.07934C12.25 5.61801 11.7783 6.05469 11.1963 6.05469C10.7385 6.05469 10.333 5.78094 10.1931 5.37734L9.32279 2.8668Z',
      fill: '#FFC700',
    }),
    React.createElement('path', {
      d:
        'M10.825 1.26941C11.1413 1.50339 10.6373 1.71436 10.293 2.17982C9.94869 2.64527 9.89449 3.18896 9.57817 2.95498C9.26185 2.72101 9.32403 2.18322 9.66832 1.71776C10.0126 1.2523 10.5086 1.03544 10.825 1.26941Z',
      fill: '#FFD800',
    }),
    React.createElement('path', {
      d:
        'M14.6507 1.39423C14.8957 1.70211 14.3543 1.77544 13.9012 2.13593C13.4482 2.49642 13.2551 3.00755 13.0102 2.69968C12.7652 2.3918 12.9644 1.88843 13.4174 1.52794C13.8705 1.16746 14.4057 1.08636 14.6507 1.39423Z',
      fill: '#FFD800',
    }),
    React.createElement('path', {
      d:
        'M10.3026 1.54788C10.4525 1.65871 10.1853 1.79706 9.98717 2.06492C9.78903 2.33278 9.73495 2.62873 9.58511 2.51789C9.43528 2.40706 9.49314 2.11391 9.69127 1.84605C9.88941 1.57819 10.1528 1.43705 10.3026 1.54788Z',
      fill: '#FEED8D',
    }),
    React.createElement('path', {
      d:
        'M14.0738 1.5278C14.1899 1.67363 13.896 1.73812 13.6353 1.94557C13.3746 2.15302 13.2458 2.42489 13.1297 2.27905C13.0137 2.13322 13.1454 1.86503 13.4061 1.65758C13.6668 1.45012 13.9578 1.38196 14.0738 1.5278Z',
      fill: '#FEED8D',
    }),
    React.createElement('path', {
      d:
        'M13.406 5.80534C13.1769 5.64322 13.6402 5.49916 14.0299 5.10944C14.4196 4.71971 14.4298 4.07338 14.6827 4.32626C14.9356 4.57915 14.7916 5.0668 14.4019 5.45652C14.0122 5.84624 13.6351 5.96747 13.406 5.80534Z',
      fill: '#FFAF00',
    }),
    React.createElement('path', {
      d:
        'M10.6248 5.80534C10.3957 5.64322 10.8589 5.49916 11.2486 5.10944C11.6383 4.71971 11.6486 4.07338 11.9015 4.32626C12.1543 4.57915 12.0103 5.0668 11.6206 5.45652C11.2309 5.84624 10.8538 5.96747 10.6248 5.80534Z',
      fill: '#FFAF00',
    }),
    React.createElement('path', {
      d:
        'M13.9914 10.3006C12.9839 8.40915 12.4375 6.30469 12.4375 6.30469C12.4375 6.30469 11.9087 8.34165 10.9321 10.2086C10.6414 11.6927 9.56271 12.9024 8.10162 13.3682C6.2379 13.9624 4.40451 13.1384 3.73966 11.239C3.00517 10.5247 2.41808 9.75079 2.125 9.15553V10.3668C2.125 14.1503 3.02673 17.8564 4.72554 21.0547H20.1495C21.8483 17.8564 22.75 14.1503 22.75 10.3668V9.15553C22.4628 9.73876 21.8934 10.4935 21.1797 11.1956C20.5277 13.1259 18.6807 13.967 16.8028 13.3682C15.372 12.912 14.3079 11.7426 13.9914 10.3006Z',
      fill: '#FFC700',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M13.8289 9.68799C13.8905 9.81475 13.9542 9.94142 14.02 10.0673C14.3079 11.5381 15.3758 12.7369 16.8224 13.1986C18.6677 13.7875 20.4828 12.9709 21.1411 11.0884C21.1766 11.0538 21.2118 11.0191 21.2466 10.9843C21.239 11.1885 21.2128 11.393 21.1672 11.5959C20.7544 13.4308 18.9066 14.4353 16.7837 13.7578C14.8194 13.1309 13.6636 11.3971 13.8289 9.68799Z',
      fill: '#FFD800',
    }),
    React.createElement('path', {
      d:
        'M16.25 7.99219C16.25 9.80885 14.5431 11.0547 12.4375 11.0547C10.3319 11.0547 8.625 9.80885 8.625 7.99219C8.625 6.17553 10.3319 4.92969 12.4375 4.92969C14.5431 4.92969 16.25 6.17553 16.25 7.99219Z',
      fill: '#FFC700',
    }),
    React.createElement('path', {
      d:
        'M14.5349 6.09354C14.807 7.1091 13.4021 6.71163 11.9077 7.11205C10.4134 7.51246 9.39541 8.55914 9.12329 7.54357C8.85117 6.52801 9.87598 5.50694 11.3704 5.10652C12.8647 4.70611 14.2628 5.07797 14.5349 6.09354Z',
      fill: '#FFD800',
    }),
    React.createElement('path', {
      d:
        'M11.0893 10.2853C10.7875 9.70556 11.9478 9.89409 13.237 9.49295C14.5262 9.09181 15.3014 7.75528 15.5484 8.54928C15.7955 9.34329 14.9187 10.2079 13.6295 10.609C12.3403 11.0102 11.3911 10.865 11.0893 10.2853Z',
      fill: '#FFAF00',
    }),
    React.createElement('path', {
      d:
        'M12.979 5.80657C13.1079 6.28763 12.3191 6.1324 11.4591 6.36283C10.5992 6.59326 9.99366 7.1221 9.86476 6.64104C9.73586 6.15998 10.3446 5.64328 11.2046 5.41284C12.0646 5.18241 12.8501 5.32552 12.979 5.80657Z',
      fill: '#FEED8D',
    }),
    React.createElement('path', {
      d:
        'M11.7222 8.09327C11.7222 8.76484 11.4227 9.01955 11.0533 9.01955C10.6838 9.01955 10.3843 8.76484 10.3843 8.09327C10.3843 7.4217 10.6838 7.16699 11.0533 7.16699C11.4227 7.16699 11.7222 7.4217 11.7222 8.09327Z',
      fill: '#FEED8D',
    }),
    React.createElement('path', {
      d:
        'M11.7222 7.94581C11.7222 8.61738 11.4227 8.87209 11.0533 8.87209C10.6838 8.87209 10.3843 8.61738 10.3843 7.94581C10.3843 7.27424 10.6838 7.01953 11.0533 7.01953C11.4227 7.01953 11.7222 7.27424 11.7222 7.94581Z',
      fill: '#CC240E',
    }),
    React.createElement('path', {
      d:
        'M11.4119 7.41061C11.4587 7.67736 11.217 7.57296 10.9599 7.67813C10.7028 7.78331 10.5276 8.05822 10.4808 7.79148C10.434 7.52473 10.6103 7.25654 10.8674 7.15136C11.1245 7.04619 11.3651 7.14386 11.4119 7.41061Z',
      fill: '#FA7048',
    }),
    React.createElement('path', {
      d:
        'M10.796 8.61486C10.7456 8.421 10.9921 8.50242 11.2088 8.3668C11.4256 8.23119 11.5783 7.83458 11.6194 8.10027C11.6605 8.36596 11.4909 8.60461 11.2742 8.74023C11.0575 8.87584 10.8465 8.80873 10.796 8.61486Z',
      fill: '#9F0400',
    }),
    React.createElement('path', {
      d:
        'M14.1924 8.09327C14.1924 8.76484 13.8929 9.01955 13.5235 9.01955C13.154 9.01955 12.8545 8.76484 12.8545 8.09327C12.8545 7.4217 13.154 7.16699 13.5235 7.16699C13.8929 7.16699 14.1924 7.4217 14.1924 8.09327Z',
      fill: '#FEED8D',
    }),
    React.createElement('path', {
      d:
        'M14.1924 7.94581C14.1924 8.61738 13.8929 8.87209 13.5235 8.87209C13.154 8.87209 12.8545 8.61738 12.8545 7.94581C12.8545 7.27424 13.154 7.01953 13.5235 7.01953C13.8929 7.01953 14.1924 7.27424 14.1924 7.94581Z',
      fill: '#CC240E',
    }),
    React.createElement('path', {
      d:
        'M13.8821 7.41061C13.9289 7.67736 13.6872 7.57296 13.4301 7.67813C13.173 7.78331 12.9978 8.05822 12.951 7.79148C12.9042 7.52473 13.0805 7.25654 13.3376 7.15136C13.5947 7.04619 13.8353 7.14386 13.8821 7.41061Z',
      fill: '#FA7048',
    }),
    React.createElement('path', {
      d:
        'M13.2663 8.61486C13.2158 8.421 13.4623 8.50242 13.6791 8.3668C13.8958 8.23119 14.0485 7.83458 14.0896 8.10027C14.1307 8.36596 13.9612 8.60461 13.7444 8.74023C13.5277 8.87584 13.3167 8.80873 13.2663 8.61486Z',
      fill: '#9F0400',
    }),
    React.createElement('path', {
      d:
        'M24.3751 9.78352C24.3751 10.8765 23.4126 11.6261 22.2254 11.6261C21.0381 11.6261 20.0757 10.8765 20.0757 9.78352C20.0757 8.6905 21.0381 7.94092 22.2254 7.94092C23.4126 7.94092 24.3751 8.6905 24.3751 9.78352Z',
      fill: '#FFC700',
    }),
    React.createElement('path', {
      d:
        'M23.4327 8.66844C23.5873 9.24565 22.7888 9.01974 21.9395 9.24732C21.0902 9.47491 20.5116 10.0698 20.3569 9.49259C20.2023 8.91538 20.7847 8.33504 21.6341 8.10746C22.4834 7.87987 23.278 8.09123 23.4327 8.66844Z',
      fill: '#FFD800',
    }),
    React.createElement('path', {
      d:
        'M21.468 11.1604C21.2965 10.8309 21.956 10.938 22.6887 10.7101C23.4214 10.4821 23.862 9.72242 24.0024 10.1737C24.1429 10.625 23.6445 11.1164 22.9118 11.3444C22.179 11.5724 21.6396 11.4899 21.468 11.1604Z',
      fill: '#FFAF00',
    }),
    React.createElement('path', {
      d:
        'M22.5483 8.5052C22.6216 8.77861 22.1733 8.69038 21.6845 8.82135C21.1957 8.95232 20.8516 9.2529 20.7783 8.97948C20.705 8.70606 21.051 8.41238 21.5398 8.28141C22.0286 8.15044 22.4751 8.23178 22.5483 8.5052Z',
      fill: '#FEED8D',
    }),
    React.createElement('path', {
      d:
        'M4.92439 9.78352C4.92439 10.8765 3.96194 11.6261 2.7747 11.6261C1.58745 11.6261 0.625 10.8765 0.625 9.78352C0.625 8.6905 1.58745 7.94092 2.7747 7.94092C3.96194 7.94092 4.92439 8.6905 4.92439 9.78352Z',
      fill: '#FFC700',
    }),
    React.createElement('path', {
      d:
        'M3.982 8.66844C4.13667 9.24565 3.33817 9.01974 2.48882 9.24732C1.63947 9.47491 1.0609 10.0698 0.906238 9.49259C0.751574 8.91538 1.33404 8.33504 2.18339 8.10746C3.03274 7.87987 3.82734 8.09123 3.982 8.66844Z',
      fill: '#FFD800',
    }),
    React.createElement('path', {
      d:
        'M2.01735 11.1604C1.8458 10.8309 2.5053 10.938 3.23802 10.7101C3.97074 10.4821 4.41134 9.72242 4.55176 10.1737C4.69218 10.625 4.19381 11.1164 3.46109 11.3444C2.72837 11.5724 2.1889 11.4899 2.01735 11.1604Z',
      fill: '#FFAF00',
    }),
    React.createElement('path', {
      d:
        'M3.09716 8.5052C3.17042 8.77861 2.72209 8.69038 2.23331 8.82135C1.74453 8.95232 1.40038 9.2529 1.32712 8.97948C1.25386 8.70606 1.59985 8.41238 2.08863 8.28141C2.57742 8.15044 3.0239 8.23178 3.09716 8.5052Z',
      fill: '#FEED8D',
    }),
    React.createElement('path', {
      d:
        'M21 21.4833C21 22.5878 20.7489 23.0547 12.4375 23.0547C4.12611 23.0547 3.875 22.5878 3.875 21.4833C3.875 20.3787 4.12611 20.3047 12.4375 20.3047C20.7489 20.3047 21 20.3787 21 21.4833Z',
      fill: '#D8D8D8',
    }),
    React.createElement('path', {
      d:
        'M14.6123 21.583C14.5965 22.6393 13.9077 22.7662 9.15269 22.6767C5.64021 22.6106 4.71703 22.5202 4.72814 21.7777C4.73925 21.0352 5.09021 20.7512 9.18036 20.8281C13.9354 20.9176 14.6234 20.8405 14.6123 21.583Z',
      fill: '#EFF3F5',
    }),
    React.createElement('path', {
      d:
        'M5.36878 22.06C5.19105 21.8607 5.32313 21.5819 5.55794 21.3186C5.79275 21.0553 6.04136 20.9072 6.21909 21.1065C6.39682 21.3058 6.26473 21.5845 6.02992 21.8478C5.79512 22.1111 5.54651 22.2593 5.36878 22.06Z',
      fill: '#7D7D7D',
    }),
    React.createElement('path', {
      d:
        'M5.33188 22.0183C5.18225 21.8505 5.32355 21.5821 5.55836 21.3188C5.79317 21.0555 6.03256 20.897 6.18219 21.0648C6.33181 21.2326 6.19051 21.501 5.9557 21.7644C5.7209 22.0277 5.4815 22.1861 5.33188 22.0183Z',
      fill: '#373333',
    }),
    React.createElement('path', {
      d:
        'M19.1715 22.06C18.9938 21.8607 19.1259 21.5819 19.3607 21.3186C19.5955 21.0553 19.8441 20.9072 20.0218 21.1065C20.1995 21.3058 20.0675 21.5845 19.8327 21.8478C19.5978 22.1111 19.3492 22.2593 19.1715 22.06Z',
      fill: '#7D7D7D',
    }),
    React.createElement('path', {
      d:
        'M19.1374 22.0217C18.9855 21.8514 19.1261 21.5821 19.3609 21.3188C19.5957 21.0555 19.8358 20.8979 19.9877 21.0682C20.1397 21.2386 19.9991 21.5079 19.7643 21.7712C19.5295 22.0345 19.2893 22.1921 19.1374 22.0217Z',
      fill: '#373333',
    }),
    React.createElement('path', {
      d:
        'M8.71657 22.2374C8.50579 22.001 8.66243 21.6704 8.94091 21.3581C9.21938 21.0459 9.51422 20.8702 9.725 21.1066C9.93579 21.3429 9.77914 21.6736 9.50066 21.9858C9.22219 22.2981 8.92735 22.4738 8.71657 22.2374Z',
      fill: '#7D7D7D',
    }),
    React.createElement('path', {
      d:
        'M8.65967 22.1742C8.49136 21.9854 8.66193 21.6704 8.9404 21.3581C9.21887 21.0459 9.4998 20.8546 9.66811 21.0433C9.83643 21.2321 9.66585 21.5471 9.38738 21.8594C9.10891 22.1716 8.82799 22.3629 8.65967 22.1742Z',
      fill: '#373333',
    }),
    React.createElement('path', {
      d:
        'M15.8196 22.2374C15.6088 22.001 15.7655 21.6704 16.0439 21.3581C16.3224 21.0459 16.6172 20.8702 16.828 21.1066C17.0388 21.3429 16.8822 21.6736 16.6037 21.9858C16.3252 22.2981 16.0304 22.4738 15.8196 22.2374Z',
      fill: '#7D7D7D',
    }),
    React.createElement('path', {
      d:
        'M15.7716 22.1835C15.597 21.9878 15.7656 21.6705 16.0441 21.3582C16.3225 21.0459 16.6055 20.857 16.78 21.0527C16.9545 21.2483 16.786 21.5656 16.5075 21.8779C16.229 22.1902 15.9461 22.3792 15.7716 22.1835Z',
      fill: '#373333',
    }),
    React.createElement('path', {
      d:
        'M12.1406 22.3976C11.8957 22.1229 12.0777 21.7387 12.4013 21.3759C12.7249 21.013 13.0675 20.8089 13.3125 21.0835C13.5574 21.3582 13.3754 21.7424 13.0518 22.1053C12.7282 22.4681 12.3856 22.6723 12.1406 22.3976Z',
      fill: '#7D7D7D',
    }),
    React.createElement('path', {
      d:
        'M12.0921 22.3438C11.8835 22.1098 12.0775 21.7389 12.401 21.3761C12.7246 21.0132 13.0554 20.7957 13.264 21.0297C13.4726 21.2636 13.2787 21.6345 12.9551 21.9974C12.6315 22.3602 12.3008 22.5777 12.0921 22.3438Z',
      fill: '#373333',
    }),
    React.createElement('path', {
      d:
        'M12.0489 13.7369C12.2981 13.494 12.7019 13.494 12.9511 13.7369L14.8132 15.5524C15.0623 15.7953 15.0623 16.1891 14.8132 16.432L12.9511 18.2475C12.7019 18.4904 12.2981 18.4904 12.0489 18.2475L10.1868 16.432C9.93772 16.1891 9.93772 15.7953 10.1868 15.5524L12.0489 13.7369Z',
      fill: '#FFE971',
    }),
    React.createElement('path', {
      d:
        'M12.4726 13.2256V15.5732H10.125C10.125 15.4162 10.1849 15.2593 10.3046 15.1396L12.039 13.4052C12.1587 13.2855 12.3157 13.2256 12.4726 13.2256Z',
      fill: '#FA7048',
    }),
    React.createElement('path', {
      d:
        'M12.4726 17.9209V15.5733H10.125C10.125 15.7302 10.1849 15.8872 10.3046 16.0069L12.039 17.7413C12.1587 17.861 12.3157 17.9209 12.4726 17.9209Z',
      fill: '#CC240E',
    }),
    React.createElement('path', {
      d:
        'M12.4727 13.2256V15.5732H14.8203C14.8203 15.4162 14.7604 15.2593 14.6407 15.1396L12.9063 13.4052C12.7866 13.2855 12.6296 13.2256 12.4727 13.2256Z',
      fill: '#CC240E',
    }),
    React.createElement('path', {
      d:
        'M12.4727 17.9209V15.5733H14.8203C14.8203 15.7302 14.7604 15.8872 14.6407 16.0069L12.9063 17.7413C12.7866 17.861 12.6296 17.9209 12.4727 17.9209Z',
      fill: '#9F0400',
    }),
    React.createElement('path', {
      d:
        'M18.6595 15.807C18.7972 15.6548 19.0203 15.6548 19.158 15.807L20.1869 16.9442C20.3246 17.0964 20.3246 17.343 20.1869 17.4952L19.158 18.6324C19.0203 18.7846 18.7972 18.7846 18.6595 18.6324L17.6306 17.4952C17.4929 17.343 17.4929 17.0964 17.6306 16.9442L18.6595 15.807Z',
      fill: '#FFE971',
    }),
    React.createElement('path', {
      d:
        'M18.9132 15.5596V16.9244H17.5483C17.5483 16.8332 17.5831 16.742 17.6528 16.6724L18.6611 15.664C18.7307 15.5944 18.822 15.5596 18.9132 15.5596Z',
      fill: '#FA7048',
    }),
    React.createElement('path', {
      d:
        'M18.9132 18.2896V16.9247H17.5483C17.5483 17.0159 17.5831 17.1072 17.6528 17.1768L18.6611 18.1851C18.7307 18.2547 18.822 18.2896 18.9132 18.2896Z',
      fill: '#CC240E',
    }),
    React.createElement('path', {
      d:
        'M18.9134 15.5596V16.9245H20.2783C20.2783 16.8332 20.2435 16.742 20.1739 16.6724L19.1655 15.664C19.0959 15.5944 19.0047 15.5596 18.9134 15.5596Z',
      fill: '#CC240E',
    }),
    React.createElement('path', {
      d:
        'M18.9134 18.2896V16.9247H20.2783C20.2783 17.0159 20.2435 17.1072 20.1739 17.1768L19.1655 18.1851C19.0959 18.2547 19.0047 18.2896 18.9134 18.2896Z',
      fill: '#9F0400',
    }),
    React.createElement('path', {
      d:
        'M5.64194 15.807C5.77959 15.6548 6.00277 15.6548 6.14042 15.807L7.16936 16.9442C7.30701 17.0964 7.30701 17.343 7.16936 17.4952L6.14042 18.6324C6.00277 18.7846 5.77959 18.7846 5.64194 18.6324L4.613 17.4952C4.47535 17.343 4.47535 17.0964 4.613 16.9442L5.64194 15.807Z',
      fill: '#FFE971',
    }),
    React.createElement('path', {
      d:
        'M5.90931 15.5596V16.9245H4.54443C4.54443 16.8332 4.57924 16.742 4.64885 16.6724L5.65722 15.664C5.72683 15.5944 5.81807 15.5596 5.90931 15.5596Z',
      fill: '#FA7048',
    }),
    React.createElement('path', {
      d:
        'M5.90931 18.2896V16.9247H4.54443C4.54443 17.0159 4.57924 17.1072 4.64885 17.1768L5.65722 18.1851C5.72683 18.2547 5.81807 18.2896 5.90931 18.2896Z',
      fill: '#CC240E',
    }),
    React.createElement('path', {
      d:
        'M5.90905 15.5596V16.9245H7.27393C7.27393 16.8332 7.23912 16.742 7.16951 16.6724L6.16114 15.664C6.09153 15.5944 6.00029 15.5596 5.90905 15.5596Z',
      fill: '#CC240E',
    }),
    React.createElement('path', {
      d:
        'M5.90905 18.2896V16.9247H7.27393C7.27393 17.0159 7.23912 17.1072 7.16951 17.1768L6.16114 18.1851C6.09153 18.2547 6.00029 18.2896 5.90905 18.2896Z',
      fill: '#9F0400',
    })
  )
}
...
const Icon$X = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      className: 'left-eye',
      d:
        'M11.9595 18.9091C11.9595 20.248 11.2359 21.3333 10.3433 21.3333C9.45075 21.3333 8.72717 20.248 8.72717 18.9091C8.72717 17.5702 9.45075 16.4849 10.3433 16.4849C11.2359 16.4849 11.9595 17.5702 11.9595 18.9091Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      className: 'right-eye',
      d:
        'M23.1111 18.9091C23.1111 20.248 22.3875 21.3333 21.4949 21.3333C20.6024 21.3333 19.8788 20.248 19.8788 18.9091C19.8788 17.5702 20.6024 16.4849 21.4949 16.4849C22.3875 16.4849 23.1111 17.5702 23.1111 18.9091Z',
      fill: '#633001',
    })
  )
}
...
const Icon$W = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M163.099 137.354C159.576 118.299 174.05 100.695 193.238 100.695C210.172 100.695 223.899 114.562 223.899 131.669V201.777C234.247 200.404 244.986 199.682 255.998 199.682C266.755 199.682 277.252 200.371 287.378 201.683V131.669C287.378 114.562 301.105 100.695 318.039 100.695C337.227 100.695 351.701 118.299 348.178 137.354L334.189 213.028C378.439 229.44 408.047 259.36 408.047 293.548C408.047 345.389 339.972 387.415 255.998 387.415C172.024 387.415 103.95 345.389 103.95 293.548C103.95 259.533 133.257 229.744 177.134 213.279L163.099 137.354Z',
      fill: '#D1884F',
    }),
    React.createElement('path', {
      d:
        'M213.762 286.722C213.762 300.86 206.199 312.322 196.868 312.322C187.538 312.322 179.974 300.86 179.974 286.722C179.974 272.583 187.538 261.122 196.868 261.122C206.199 261.122 213.762 272.583 213.762 286.722Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      d:
        'M330.333 286.722C330.333 300.86 322.769 312.322 313.439 312.322C304.108 312.322 296.544 300.86 296.544 286.722C296.544 272.583 304.108 261.122 313.439 261.122C322.769 261.122 330.333 272.583 330.333 286.722Z',
      fill: '#633001',
    }),
    React.createElement(
      'defs',
...
const Icon$V = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M16.7095 3.10222C17.1006 1.8767 16.1861 0.625 14.8997 0.625C13.8505 0.625 13 1.47554 13 2.52473L13 6.16735C13 6.90335 13.5966 7.5 14.3326 7.5C14.9126 7.5 15.4259 7.12495 15.6022 6.57247L16.7095 3.10222Z',
      fill: '#F6AF5B',
    }),
    React.createElement('path', {
      d:
        'M8.29046 3.10222C7.89941 1.8767 8.81388 0.625 10.1003 0.625C11.1495 0.625 12 1.47554 12 2.52472L12 6.16736C12 6.90335 11.4034 7.5 10.6674 7.5C10.0874 7.5 9.57408 7.12495 9.39778 6.57247L8.29046 3.10222Z',
      fill: '#F6AF5B',
    }),
    React.createElement('path', {
      d:
        'M19.8989 24.1416L11.8536 16.0962C11.6583 15.901 11.6583 15.5844 11.8536 15.3891L15.3891 11.8536C15.5843 11.6583 15.9009 11.6583 16.0962 11.8536L24.1416 19.899C24.4325 20.1899 24.2671 20.6882 23.8599 20.7473L21.5113 21.0884C21.2923 21.1202 21.1202 21.2923 21.0884 21.5114L20.7473 23.8599C20.6882 24.2671 20.1899 24.4326 19.8989 24.1416Z',
      fill: '#AE5714',
    }),
    React.createElement('path', {
      d:
        'M5.19774 24.1416L13.2431 16.0962C13.4384 15.901 13.4384 15.5844 13.2431 15.3891L9.70759 11.8536C9.51233 11.6583 9.19575 11.6583 9.00049 11.8536L0.955098 19.899C0.664132 20.1899 0.829575 20.6882 1.23679 20.7473L3.58535 21.0884C3.80441 21.1202 3.97648 21.2923 4.0083 21.5114L4.34938 23.8599C4.40852 24.2671 4.90677 24.4326 5.19774 24.1416Z',
      fill: '#AE5714',
    }),
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M7.8727 5.68848L21.0558 14.7566C20.9018 15.3031 20.6883 15.8274 20.422 16.3232L6.43117 6.69946C6.87202 6.31918 7.35491 5.97999 7.8727 5.68848ZM4.87291 8.47883L19.0217 18.2112C18.2987 18.9421 17.4342 19.5515 16.4682 20.0023L3.75 11.2539C3.94091 10.2547 4.32789 9.31792 4.87291 8.47883Z',
      fill: '#F7D29B',
    }),
    React.createElement('ellipse', {
      rx: '6.64749',
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M18.6821 10.1773C18.5825 9.96784 18.4695 9.7613 18.3429 9.55858C16.4727 6.56549 12.3308 5.53998 9.09162 7.26804C5.85244 8.9961 4.74261 12.8234 6.61276 15.8164C6.73956 16.0194 6.87681 16.2133 7.02351 16.3979C5.65271 13.5147 6.82182 10.0792 9.84162 8.46822C12.8612 6.85733 16.6652 7.63925 18.6821 10.1773Z',
      fill: '#E17A2F',
    }),
    React.createElement('path', {
      d:
        'M9.95047 14.0798C9.03077 14.1218 8.6939 13.361 8.65027 12.4055C8.60664 11.4501 8.87277 10.6617 9.79247 10.6197C10.7122 10.5777 11.049 11.3385 11.0927 12.294C11.1363 13.2495 10.8702 14.0378 9.95047 14.0798Z',
      fill: '#AE5714',
    }),
    React.createElement('path', {
      d:
        'M15.1194 14.0803C14.1997 14.1223 13.8628 13.3615 13.8192 12.406C13.7756 11.4505 14.0417 10.6622 14.9614 10.6202C15.8811 10.5782 16.218 11.339 16.2616 12.2945C16.3052 13.25 16.0391 14.0383 15.1194 14.0803Z',
      fill: '#AE5714',
    })
  )
}
...
const Icon$R = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M7.8727 5.68848L21.0558 14.7566C20.9018 15.3031 20.6883 15.8274 20.422 16.3232L6.43117 6.69946C6.87202 6.31918 7.35491 5.97999 7.8727 5.68848ZM4.87291 8.47883L19.0217 18.2112C18.2987 18.9421 17.4342 19.5515 16.4682 20.0022L3.75 11.2539C3.94091 10.2547 4.32789 9.31792 4.87291 8.47883Z',
      fill: '#84F0F9',
    }),
    React.createElement('ellipse', {
      rx: '6.64749',
    ...
    React.createElement('path', {
      d:
        'M9.95096 14.0798C9.03126 14.1218 8.69439 13.361 8.65076 12.4055C8.60713 11.4501 8.87326 10.6617 9.79296 10.6197C10.7127 10.5777 11.0495 11.3385 11.0932 12.294C11.1368 13.2495 10.8707 14.0378 9.95096 14.0798Z',
      fill: '#017178',
    }),
    React.createElement('path', {
      d:
        'M15.1199 14.0803C14.2002 14.1223 13.8633 13.3615 13.8197 12.406C13.7761 11.4505 14.0422 10.6622 14.9619 10.6202C15.8816 10.5782 16.2185 11.339 16.2621 12.2945C16.3057 13.25 16.0396 14.0383 15.1199 14.0803Z',
      fill: '#017178',
    })
  )
}
...
const Icon$O = function (props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('path', {
        d:
          'M25.128 16.436c0 3.115-4.133 5.641-9.231 5.641s-9.231-2.526-9.231-5.641V15h18.461v1.436zm2.205 13.806c0-3.815-5.074-6.908-11.333-6.908S4.667 26.426 4.667 30.242V32h22.667v-1.759z',
        fill: secondaryColor,
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
        d:
          'M10.234 5.601C9.942 4.264 10.96 3 12.328 3c1.184 0 2.143.959 2.143 2.143v3.873l1.427-.067c.589 0 1.166.034 1.724.098V5.143c0-1.184.959-2.143 2.143-2.143 1.368 0 2.386 1.264 2.093 2.601l-.931 4.258c2.529 1.006 4.201 2.749 4.201 4.731 0 3.115-4.133 5.641-9.231 5.641s-9.231-2.526-9.231-5.641c0-2.053 1.794-3.849 4.476-4.836l-.908-4.153z',
        fill: secondaryColor,
      }),
...
const Icon$M = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M2.43832 38.1153C2.43048 38.3002 2.42654 38.4857 2.42654 38.6718C2.42654 39.3754 2.48287 40.0702 2.59273 40.7545H2.42654V41.8317C2.42654 42.3575 2.45801 42.8784 2.51976 43.3937C3.7248 53.4491 16.4632 61.3609 32 61.3609C47.5368 61.3609 60.2752 53.4491 61.4802 43.3937C61.542 42.8784 61.5735 42.3575 61.5735 41.8317V40.7545H61.4073C61.5171 40.0702 61.5735 39.3754 61.5735 38.6718C61.5735 38.4857 61.5695 38.3002 61.5617 38.1153C61.1156 27.587 48.0511 19.1426 32 19.1426C15.9489 19.1426 2.88444 27.587 2.43832 38.1153ZM0.00951064 38.1153C0.229456 31.6916 4.24297 26.2955 9.82907 22.6067C15.6197 18.7827 23.4643 16.5034 32 16.5034C40.5358 16.5034 48.3803 18.7827 54.1709 22.6067C59.757 26.2955 63.7705 31.6916 63.9905 38.1153H64V41.8317C64 48.5003 59.9176 54.102 54.1709 57.8969C48.3803 61.7208 40.5358 64.0001 32 64.0001C23.4643 64.0001 15.6197 61.7208 9.82907 57.8969C4.08238 54.102 0 48.5003 0 41.8317V38.1153H0.00951064Z',
      fill: '#606063',
    }),
    React.createElement('path', {
      d:
        'M61.5734 41.832C61.5734 52.6177 48.3329 61.3612 32 61.3612C15.667 61.3612 2.42651 52.6177 2.42651 41.832V38.7405H61.5734V41.832Z',
      fill: '#BEBEBE',
    }),
    React.createElement('path', {
      d:
        'M61.5734 38.6718C61.5734 49.4575 48.3329 58.201 32 58.201C15.667 58.201 2.42651 49.4575 2.42651 38.6718C2.42651 27.8861 15.667 19.1426 32 19.1426C48.3329 19.1426 61.5734 27.8861 61.5734 38.6718Z',
      fill: '#FAF9FA',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M13.6497 25.2371C13.6496 25.2493 13.6496 25.2615 13.6496 25.2737C13.6496 26.1618 13.7679 27.0315 13.9947 27.8762H13.6493V29.0199C13.6493 29.5248 13.6876 30.0237 13.7622 30.5154C14.8897 37.941 24.3222 43.737 35.7914 43.737C47.2605 43.737 56.693 37.941 57.8205 30.5154C57.8952 30.0237 57.9334 29.5248 57.9334 29.0199V27.8762H57.5886C57.8092 27.0545 57.9271 26.2092 57.9334 25.3464C57.9336 25.3222 57.9337 25.298 57.9337 25.2737C57.9337 25.2615 57.9337 25.2493 57.9336 25.2371C57.9038 17.1259 48.0019 10.5567 35.7916 10.5567C23.5813 10.5567 13.6794 17.1259 13.6497 25.2371ZM11.2231 25.2371H11.2228V29.0199C11.2228 34.3513 14.4641 38.7505 18.8693 41.6785C23.316 44.6341 29.3049 46.3762 35.7914 46.3762C42.2778 46.3762 48.2667 44.6341 52.7135 41.6785C57.1186 38.7505 60.36 34.3513 60.36 29.0199V25.3561C60.3601 25.3287 60.3602 25.3012 60.3602 25.2737C60.3602 19.9424 57.1189 15.5432 52.7137 12.6152C48.267 9.65961 42.2781 7.91748 35.7916 7.91748C29.3052 7.91748 23.3163 9.65961 18.8695 12.6152C14.4745 15.5364 11.2379 19.9222 11.2231 25.2371Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      d:
        'M57.9334 29.0201C57.9334 37.1481 48.0201 43.7372 35.7913 43.7372C23.5626 43.7372 13.6493 37.1481 13.6493 29.0201V25.5671H57.9334V29.0201Z',
      fill: '#FEDC90',
    }),
    React.createElement('path', {
      d:
        'M57.9334 25.274C57.9334 33.402 48.0201 39.991 35.7913 39.991C23.5626 39.991 13.6493 33.402 13.6493 25.274C13.6493 17.1459 23.5626 10.5569 35.7913 10.5569C48.0201 10.5569 57.9334 17.1459 57.9334 25.274Z',
      fill: '#D1884F',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M6.97668 17.3196C6.97663 17.3318 6.97661 17.344 6.97661 17.3563C6.97661 18.2443 7.09495 19.114 7.32173 19.9588H6.97634V21.1025C6.97634 21.6073 7.01459 22.1062 7.08925 22.598C8.21673 30.0236 17.6492 35.8195 29.1184 35.8195C40.5876 35.8195 50.0201 30.0236 51.1475 22.598C51.2222 22.1062 51.2604 21.6073 51.2604 21.1025V19.9588H50.9156C51.1362 19.1371 51.2542 18.2917 51.2604 17.4289C51.2606 17.4047 51.2607 17.3805 51.2607 17.3563C51.2607 17.344 51.2607 17.3318 51.2606 17.3196C51.2309 9.20843 41.329 2.63919 29.1187 2.63919C16.9083 2.63919 7.00645 9.20843 6.97668 17.3196ZM4.55012 17.3196H4.5498V21.1025C4.5498 26.4338 7.79116 30.833 12.1963 33.761C16.643 36.7166 22.632 38.4587 29.1184 38.4587C35.6048 38.4587 41.5937 36.7166 46.0405 33.761C50.4456 30.833 53.687 26.4338 53.687 21.1025V17.4387C53.6872 17.4112 53.6872 17.3837 53.6872 17.3563C53.6872 12.0249 50.4459 7.62568 46.0408 4.69775C41.594 1.74213 35.6051 0 29.1187 0C22.6322 0 16.6433 1.74213 12.1965 4.69775C7.80153 7.61896 4.56495 12.0047 4.55012 17.3196Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      d:
        'M51.2604 21.1027C51.2604 29.2307 41.3471 35.8197 29.1184 35.8197C16.8897 35.8197 6.97632 29.2307 6.97632 21.1027V17.6497H51.2604V21.1027Z',
      fill: '#FEDC90',
    }),
    React.createElement('path', {
      d:
        'M51.2604 17.3562C51.2604 25.4842 41.3471 32.0733 29.1184 32.0733C16.8897 32.0733 6.97632 25.4842 6.97632 17.3562C6.97632 9.22822 16.8897 2.63916 29.1184 2.63916C41.3471 2.63916 51.2604 9.22822 51.2604 17.3562Z',
      fill: '#D1884F',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M12.214 18.272C12.214 20.9856 14.0269 23.4161 16.8871 25.0513L14.9054 28.7844L14.9059 28.7847H14.9054V38.2326C14.9054 39.4819 15.8366 40.4947 16.9853 40.4947C18.134 40.4947 19.0652 39.4819 19.0652 38.2326V30.7188L21.1972 26.7024C22.5605 27.0169 24.0238 27.1876 25.5468 27.1876C32.9103 27.1876 38.8796 23.196 38.8796 18.272C38.8796 13.3481 32.9103 9.35645 25.5468 9.35645C18.1833 9.35645 12.214 13.3481 12.214 18.272Z',
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M16.8871 25.0513C16.5702 24.8701 16.2663 24.6792 15.9762 24.4793C13.6475 22.8741 12.2139 20.685 12.2139 18.272C12.2139 13.3481 18.1832 9.35641 25.5468 9.35641C32.9103 9.35641 38.8796 13.3481 38.8796 18.272C38.8796 23.1959 32.9103 27.1876 25.5468 27.1876C24.0238 27.1876 22.5604 27.0168 21.1972 26.7024L19.0652 30.7187V38.2325C19.0652 39.4819 18.134 40.4947 16.9853 40.4947C15.8366 40.4947 14.9054 39.4819 14.9054 38.2325V28.7847L16.8871 25.0513ZM12.7822 28.8244V38.2325C12.7822 40.7573 14.664 42.804 16.9853 42.804C19.3066 42.804 21.1884 40.7573 21.1884 38.2325V31.3375L22.2942 29.2544C23.3445 29.4135 24.433 29.4969 25.5468 29.4969C29.5564 29.4969 33.2881 28.4148 36.0865 26.5435C38.8503 24.6954 41.0028 21.836 41.0028 18.272C41.0028 14.708 38.8503 11.8486 36.0865 10.0005C33.2881 8.12923 29.5564 7.04712 25.5468 7.04712C21.5371 7.04712 17.8054 8.12923 15.007 10.0005C12.2432 11.8486 10.0907 14.708 10.0907 18.272C10.0907 21.4 11.738 23.9758 14.0266 25.8213L13.0813 27.6021C12.9912 27.7662 12.9192 27.9435 12.8685 28.1307C12.8064 28.3589 12.7783 28.5928 12.7822 28.8244Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      d:
        'M16.3791 14.5156C16.3791 17.0663 19.3667 19.1341 23.0521 19.1341C26.7375 19.1341 29.7251 17.0663 29.7251 14.5156C29.7251 11.9648 26.7375 9.89697 23.0521 9.89697C19.3667 9.89697 16.3791 11.9648 16.3791 14.5156Z',
      fill: '#9E7200',
    }),
    React.createElement('path', { d: 'M16.3792 12.5361H29.7251V14.5155H16.3792V12.5361Z', fill: '#9E7200' }),
    React.createElement('path', {
      d:
        'M16.3791 12.5361C16.3791 15.0868 19.3667 17.1546 23.0521 17.1546C26.7375 17.1546 29.7251 15.0868 29.7251 12.5361C29.7251 9.98529 26.7375 7.91748 23.0521 7.91748C19.3667 7.91748 16.3791 9.98529 16.3791 12.5361Z',
      fill: '#F0B90B',
    }),
    React.createElement('path', {
      d:
        'M20.52 11.9795L22.4008 10.6777C22.7983 10.4027 23.3062 10.4027 23.7036 10.6777L25.5845 11.9795C25.959 12.2388 25.959 12.8336 25.5845 13.0928L23.7036 14.3946C23.3062 14.6697 22.7983 14.6697 22.4008 14.3946L20.52 13.0928C20.1454 12.8336 20.1454 12.2388 20.52 11.9795Z',
      fill: '#9E7200',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
...
const Icon$L = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M15.7703 49.9442C15.7626 50.1122 15.7587 50.2809 15.7587 50.4501C15.7587 51.0897 15.8144 51.7214 15.923 52.3435H15.7587V53.3228C15.7587 53.8008 15.7898 54.2744 15.8508 54.7428C17.0423 63.8844 29.6377 71.0772 45 71.0772C60.3623 71.0772 72.9577 63.8844 74.1492 54.7428C74.2102 54.2744 74.2413 53.8008 74.2413 53.3228V52.3435H74.077C74.1856 51.7214 74.2413 51.0897 74.2413 50.4501C74.2413 50.2809 74.2374 50.1122 74.2297 49.9442C73.7886 40.3727 60.8709 32.6957 45 32.6957C29.1291 32.6957 16.2114 40.3727 15.7703 49.9442ZM13.3688 49.9442C13.5863 44.1042 17.5547 39.1986 23.0781 35.845C28.8037 32.3686 36.5601 30.2964 45 30.2964C53.4399 30.2964 61.1964 32.3686 66.9219 35.845C72.4453 39.1986 76.4137 44.1042 76.6312 49.9442H76.6406V53.3228C76.6406 59.3853 72.6041 64.4779 66.9219 67.9279C61.1964 71.4043 53.4399 73.4765 45 73.4765C36.5601 73.4765 28.8037 71.4043 23.0781 67.9279C17.3959 64.4779 13.3594 59.3853 13.3594 53.3228V49.9442H13.3688Z',
      fill: '#606063',
    }),
    React.createElement('path', {
      d:
        'M74.2412 53.3233C74.2412 63.1287 61.1494 71.0776 44.9999 71.0776C28.8503 71.0776 15.7585 63.1287 15.7585 53.3233V50.5127H74.2412V53.3233Z',
      fill: '#BEBEBE',
    }),
    React.createElement('path', {
      d:
        'M74.2412 50.4502C74.2412 60.2557 61.1494 68.2046 44.9999 68.2046C28.8503 68.2046 15.7585 60.2557 15.7585 50.4502C15.7585 40.6447 28.8503 32.6958 44.9999 32.6958C61.1494 32.6958 74.2412 40.6447 74.2412 50.4502Z',
      fill: '#FAF9FA',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M20.2578 31.0385C20.2577 31.0496 20.2577 31.0607 20.2577 31.0719C20.2577 31.8792 20.3747 32.6699 20.5989 33.4379H20.2574V34.4776C20.2574 34.9366 20.2953 35.3901 20.3691 35.8372C21.4839 42.5879 30.8104 47.8572 42.1508 47.8572C53.4912 47.8572 62.8178 42.5879 63.9326 35.8372C64.0064 35.3901 64.0442 34.9366 64.0442 34.4776V33.4379H63.7032C63.9213 32.6908 64.038 31.9223 64.0442 31.1379C64.0444 31.1159 64.0445 31.0939 64.0445 31.0719C64.0445 31.0607 64.0444 31.0496 64.0444 31.0385C64.015 23.6645 54.2243 17.6923 42.1511 17.6923C30.0779 17.6923 20.2872 23.6645 20.2578 31.0385ZM17.8585 31.0385H17.8582V34.4776C17.8582 39.3244 21.0631 43.3239 25.4188 45.9857C29.8156 48.6727 35.7372 50.2565 42.1508 50.2565C48.5644 50.2565 54.4861 48.6727 58.8829 45.9857C63.2385 43.3239 66.4435 39.3244 66.4435 34.4776V31.1468C66.4437 31.1218 66.4438 31.0968 66.4438 31.0719C66.4438 26.2251 63.2388 22.2256 58.8832 19.5638C54.4863 16.8768 48.5647 15.293 42.1511 15.293C35.7375 15.293 29.8158 16.8768 25.419 19.5638C21.0734 22.2195 17.8731 26.2067 17.8585 31.0385Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      d:
        'M64.0441 34.4778C64.0441 41.8671 54.2421 47.8574 42.1507 47.8574C30.0593 47.8574 20.2573 41.8671 20.2573 34.4778V31.3386H64.0441V34.4778Z',
      fill: '#FEDC90',
    }),
    React.createElement('path', {
      d:
        'M64.0441 31.0719C64.0441 38.4613 54.2421 44.4515 42.1507 44.4515C30.0593 44.4515 20.2573 38.4613 20.2573 31.0719C20.2573 23.6826 30.0593 17.6924 42.1507 17.6924C54.2421 17.6924 64.0441 23.6826 64.0441 31.0719Z',
      fill: '#D1884F',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M25.4361 31.9044C25.4361 34.3714 27.2287 36.5809 30.0567 38.0676L28.0973 41.4614L28.0977 41.4617H28.0973V50.0509C28.0973 51.1867 29.018 52.1075 30.1538 52.1075C31.2896 52.1075 32.2104 51.1867 32.2104 50.0509V43.22L34.3184 39.5686C35.6663 39.8545 37.1133 40.0097 38.6192 40.0097C45.9 40.0097 51.8022 36.3808 51.8022 31.9044C51.8022 27.428 45.9 23.7991 38.6192 23.7991C31.3383 23.7991 25.4361 27.428 25.4361 31.9044Z',
    ...
    React.createElement(
      ...
      React.createElement(
        'linearGradient',
        { id: 'paint0_linear_pancakeround', x1: '45', y1: '0', x2: '45', y2: '90', gradientUnits: 'userSpaceOnUse' },
        React.createElement('stop', { stopColor: '#54DADE' }),
        React.createElement('stop', { offset: '0.762157', stopColor: '#24C7D6' })
      ),
      React.createElement(
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('path', {
        ...
        clipRule: 'evenodd',
        d:
          'M44.4825 9.78846C44.9985 10.9575 44.934 12.0841 44.3506 13.0946C43.7672 14.105 42.8238 14.7242 41.5534 14.8619C40.2449 15.0037 38.5223 14.6345 36.5148 13.4755C34.5072 12.3164 33.3262 11.0092 32.7948 9.80511C32.2788 8.63603 32.3433 7.50943 32.9267 6.49898C33.5101 5.48854 34.4535 4.86941 35.7239 4.73171C37.0324 4.5899 38.755 4.95904 40.7625 6.1181C42.7701 7.27716 43.9511 8.58438 44.4825 9.78846ZM46.7339 8.79481C45.9315 6.97669 44.3045 5.3214 41.993 3.98688C39.6815 2.65235 37.4345 2.07098 35.4588 2.28512C33.445 2.50338 31.7896 3.54667 30.7955 5.26852C29.8014 6.99038 29.7255 8.94565 30.5434 10.7988C31.3458 12.6169 32.9728 14.2722 35.2843 15.6067C37.5958 16.9412 39.8428 17.5226 41.8185 17.3085C43.8323 17.0902 45.4877 16.0469 46.4818 14.325C47.4759 12.6032 47.5518 10.6479 46.7339 8.79481Z',
        fill: '#FFAF00',
      }),
      React.createElement('path', {
        d:
          'M39.2061 12.466C39.4779 11.9952 39.3166 11.3932 38.8458 11.1213L37.3879 10.2796C36.9171 10.0078 36.315 10.1691 36.0432 10.6399L33.7667 14.5829C33.4949 15.0537 33.6562 15.6558 34.127 15.9276L35.5849 16.7693C36.0557 17.0411 36.6577 16.8798 36.9296 16.409L39.2061 12.466Z',
        fill: '#EB8C00',
      }),
      React.createElement('path', {
        d:
          'M42.8521 10.8222C43.1239 10.3514 42.9626 9.74937 42.4917 9.47754L36.9885 6.30023C36.5177 6.02841 35.9156 6.18972 35.6438 6.66054L34.4249 8.77169C34.1531 9.2425 34.3144 9.84453 34.7852 10.1164L40.2885 13.2937C40.7593 13.5655 41.3614 13.4042 41.6332 12.9334L42.8521 10.8222Z',
        fill: '#FFAF00',
      }),
      React.createElement('path', {
        d:
          'M42.8521 10.8222C43.1239 10.3514 42.9626 9.74937 42.4917 9.47754L38.2605 7.03465C37.7897 6.76282 37.1877 6.92413 36.9159 7.39495L35.9418 9.08208C35.67 9.5529 35.8313 10.1549 36.3021 10.4268L40.5333 12.8697C41.0041 13.1415 41.6062 12.9802 41.878 12.5093L42.8521 10.8222Z',
        fill: '#FFD800',
      }),
      React.createElement('path', {
        d:
          'M42.2502 9.90623C42.3862 9.67082 42.3055 9.3698 42.0701 9.23389L41.2265 8.74685C40.9911 8.61094 40.6901 8.6916 40.5542 8.92701L39.0879 11.4666C38.952 11.702 39.0327 12.0031 39.2681 12.139L40.1117 12.626C40.3471 12.7619 40.6481 12.6813 40.784 12.4458L42.2502 9.90623Z',
        fill: '#FFE971',
      }),
      React.createElement('path', {
        d:
          'M14.4276 37.9808C19.0474 45.9826 29.0239 48.079 37.1341 43.3966C45.2442 38.7142 48.4169 29.0261 43.7971 21.0244C39.1773 13.0227 29.2008 10.9262 21.0907 15.6086C12.9805 20.291 9.80785 29.9791 14.4276 37.9808Z',
        fill: '#EB8C00',
      }),
      React.createElement('path', {
        d:
          'M12.9928 35.4957C17.6126 43.4975 27.5891 45.5939 35.6993 40.9115C43.8094 36.2291 46.9821 26.541 42.3623 18.5393C37.7425 10.5375 27.766 8.4411 19.6558 13.1235C11.5457 17.8059 8.37303 27.494 12.9928 35.4957Z',
        fill: '#FFD800',
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
        clipRule: 'evenodd',
        d:
          'M11.7043 22.6394C12.3316 20.7707 13.3072 19.0005 14.5942 17.4155L44.4474 25.2401C44.6009 27.2114 44.3704 29.1765 43.7923 31.0497L11.7043 22.6394ZM39.463 38.0997C40.3335 37.2422 41.1005 36.3113 41.7564 35.3244L10.887 27.2335C10.8573 28.381 10.9556 29.5386 11.1892 30.6891L39.463 38.0997Z',
        fill: '#FFE971',
      }),
      React.createElement('path', {
        d:
          'M15.0259 34.3218C19.0448 41.2826 27.6684 43.1382 34.6556 39.1041C41.6428 35.07 44.3477 26.674 40.3288 19.7131C36.31 12.7523 27.6863 10.8967 20.6991 14.9308C13.7119 18.9649 11.0071 27.3609 15.0259 34.3218Z',
        fill: '#FFC700',
      }),
      React.createElement('path', {
        d:
          'M16.5423 33.2959C20.044 39.3611 27.4985 40.8267 33.6123 37.2969C39.7261 33.7671 42.1841 26.5785 38.6824 20.5134C35.1806 14.4482 27.7262 12.9826 21.6123 16.5124C15.4985 20.0422 13.0406 27.2308 16.5423 33.2959Z',
        fill: 'white',
      }),
      React.createElement('path', {
        d:
          'M19.6485 19.4094C18.7716 20.2171 20.1105 20.7851 21.1076 20.1316C22.9645 18.9145 25.1882 18.2126 27.5811 18.2248C31.0292 18.2423 34.1409 19.7388 36.319 22.1137C37.0584 22.9199 38.4114 22.545 37.8645 21.5976C34.5623 15.878 27.6235 14.4433 21.9702 17.7072C21.1156 18.2006 20.3393 18.7732 19.6485 19.4094Z',
        fill: '#E7E8E8',
      }),
      React.createElement('path', {
        d:
          'M34.6395 35.043C35.5545 34.2788 34.2368 33.6843 33.2067 34.2845C31.5603 35.2437 29.6432 35.7884 27.5946 35.7783C24.3428 35.7623 21.4084 34.3516 19.3546 32.1127C18.6572 31.3525 17.381 31.706 17.8968 32.5993C21.0104 37.9921 27.5541 39.344 32.8862 36.2656C33.5169 35.9014 34.1025 35.4916 34.6395 35.043Z',
        fill: '#E7E8E8',
      }),
      React.createElement('path', {
        d:
          'M32.5972 20.6118C32.801 20.2587 32.6801 19.8071 32.3269 19.6033L32.0205 19.4263C31.6673 19.2225 31.2158 19.3434 31.0119 19.6966L28.0893 24.7587C27.8854 25.1118 28.0064 25.5633 28.3595 25.7672L28.666 25.9442C29.0191 26.148 29.4707 26.027 29.6745 25.6739L32.5972 20.6118Z',
        fill: '#452A7A',
      }),
      React.createElement('path', {
        d:
          'M21.2036 27.5233C20.8098 27.6288 20.576 28.0336 20.6816 28.4275L20.7784 28.789C20.884 29.1828 21.2888 29.4166 21.6826 29.311L26.2569 28.0854C26.6507 27.9798 26.8844 27.575 26.7789 27.1812L26.682 26.8197C26.5765 26.4258 26.1717 26.1921 25.7778 26.2976L21.2036 27.5233Z',
        fill: '#452A7A',
      }),
      React.createElement('path', {
        d:
          'M25.4809 25.6151C26.244 24.2934 27.8023 23.9359 29.053 24.658C30.3037 25.3801 30.7732 26.9084 30.0101 28.23C29.247 29.5517 27.6887 29.9093 26.438 29.1872C25.1873 28.4651 24.7178 26.9368 25.4809 25.6151Z',
        fill: '#452A7A',
      }),
      React.createElement('path', {
        d:
          'M17.0126 14.6084C16.4241 14.2686 15.5801 14.6286 15.1275 15.4126L10.989 22.5807C10.5364 23.3647 10.6466 24.2756 11.2351 24.6154L11.8085 24.9464C12.397 25.2862 13.241 24.9262 13.6936 24.1422L17.8321 16.9741C18.2847 16.1901 18.1745 15.2792 17.586 14.9394L17.0126 14.6084Z',
        fill: '#EB8C00',
      }),
      React.createElement('path', {
        d:
          'M1.87053 28.4667C-1.14632 26.725 -0.193534 19.9443 3.7222 13.162C7.63794 6.37974 13.0338 2.16425 16.0507 3.90603C19.0675 5.64781 18.1147 12.4285 14.199 19.2108C10.2833 25.993 4.88739 30.2085 1.87053 28.4667Z',
        fill: '#FFC700',
      }),
      React.createElement('path', {
        d:
          'M3.24974 28.6111C0.902471 27.273 2.13775 21.219 5.79373 14.9665C9.44971 8.71396 14.1419 4.63067 16.4892 5.96878C18.8365 7.30688 17.6012 13.3609 13.9452 19.6134C10.2892 25.8659 5.59701 29.9492 3.24974 28.6111Z',
        fill: '#FFD800',
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
        clipRule: 'evenodd',
        d:
          'M2.32523 23.3938C2.57644 22.2148 2.99217 20.9038 3.55715 19.5196L17.6473 7.92463C17.7625 8.75342 17.6984 9.77478 17.4703 10.9308L2.32523 23.3938ZM15.6081 16.3772C15.9949 15.5396 16.3319 14.7209 16.6159 13.9331L2.04567 25.923C2.0571 26.4661 2.12846 26.9487 2.26274 27.3591L15.6081 16.3772Z',
        fill: '#FFE971',
      })
    ),
    React.createElement(
...
const Icon$J = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M9 14.7902C9 15.555 9.82366 16.0367 10.4903 15.6617L15.4505 12.8716C16.1302 12.4893 16.1302 11.5107 15.4505 11.1284L10.4903 8.33827C9.82366 7.96331 9 8.44502 9 9.20985V14.7902ZM12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z',
    })
  )
}
...
const Icon$H = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M5 10C5 10.55 5.45 11 6 11H14C14.55 11 15 10.55 15 10C15 9.45 14.55 9 14 9H6C5.45 9 5 9.45 5 10ZM10 0C4.48 0 0 4.48 0 10C0 15.52 4.48 20 10 20C15.52 20 20 15.52 20 10C20 4.48 15.52 0 10 0ZM10 18C5.59 18 2 14.41 2 10C2 5.59 5.59 2 10 2C14.41 2 18 5.59 18 10C18 14.41 14.41 18 10 18Z',
    })
  )
}
...
const Icon$G = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M23 12L20.56 9.21L20.9 5.52L17.29 4.7L15.4 1.5L12 2.96L8.6 1.5L6.71 4.69L3.1 5.5L3.44 9.2L1 12L3.44 14.79L3.1 18.49L6.71 19.31L8.6 22.5L12 21.03L15.4 22.49L17.29 19.3L20.9 18.48L20.56 14.79L23 12ZM9.38 16.01L7 13.61C6.61 13.22 6.61 12.59 7 12.2L7.07 12.13C7.46 11.74 8.1 11.74 8.49 12.13L10.1 13.75L15.25 8.59C15.64 8.2 16.28 8.2 16.67 8.59L16.74 8.66C17.13 9.05 17.13 9.68 16.74 10.07L10.82 16.01C10.41 16.4 9.78 16.4 9.38 16.01Z',
    })
  )
}
...
const Icon$F = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M8.5 13.0084C13.1944 8.40751 20.8056 8.40751 25.5 13.0084C30.1944 17.6093 30.1944 25.0689 25.5 29.6698L17.6538 37.3597C17.2927 37.7136 16.7073 37.7136 16.3462 37.3597L8.5 29.6698C3.80558 25.0689 3.80558 17.6093 8.5 13.0084Z',
      fill: '#D1884F',
    }),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('path', {
          ...
          clipRule: 'evenodd',
          d:
            'M39.9264 46.3239L31.8613 48.485L32.1926 49.7213L40.2577 47.5603L39.9264 46.3239ZM29.7019 40.4262L37.767 38.2651L37.4358 37.0287L29.3707 39.1898L29.7019 40.4262Z',
          fill: '#7645D9',
        })
      ),
      React.createElement('path', {
...
const Icon$C = function (props) {
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('path', {
        d:
          'M15.9617 4.03476C16.5597 2.82143 15.6818 1.40061 14.2254 1.22477C13.0389 1.08149 11.9708 1.84428 11.8399 2.9285L11.3896 6.65764C11.2976 7.41951 11.899 8.11875 12.7328 8.21943C13.3889 8.29864 14.0166 7.98162 14.286 7.435L15.9617 4.03476Z',
        fill: '#1FC7D4',
      }),
      React.createElement('path', {
        d:
          'M6.27612 5.16903C5.36287 4.17118 5.80868 2.56162 7.15782 1.98574C8.25706 1.51653 9.49573 1.95041 9.92446 2.95482L11.3991 6.40949C11.7004 7.11529 11.3184 7.95473 10.546 8.28444C9.93817 8.54388 9.24684 8.41494 8.83541 7.9654L6.27612 5.16903Z',
        fill: '#1FC7D4',
      }),
      React.createElement('path', {
        d:
          'M17.0349 9.11691C17.3916 11.6186 15.2219 13.6784 12.2437 14.1031C9.26546 14.5278 6.60649 13.1564 6.24978 10.6548C5.89307 8.15311 8.06278 6.09324 11.041 5.66857C14.0192 5.24391 16.6782 6.61525 17.0349 9.11691Z',
        fill: '#1FC7D4',
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
        clipRule: 'evenodd',
        d:
          'M7.53552 12.9725C8.66378 13.937 10.392 14.3672 12.2437 14.1032C14.913 13.7225 16.9328 12.0284 17.0663 9.87986C16.4991 11.4567 14.8084 12.7917 12.6007 13.3832C10.6865 13.8961 8.82955 13.7307 7.53552 12.9725Z',
        fill: '#0098A1',
      }),
      React.createElement('path', {
        d:
          'M11.1696 9.94964C11.3325 10.6295 11.0911 10.9601 10.717 11.0497C10.343 11.1393 9.97795 10.9541 9.81504 10.2742C9.65212 9.5943 9.89356 9.26377 10.2676 9.17414C10.6417 9.08451 11.0067 9.26973 11.1696 9.94964Z',
        fill: '#017178',
      }),
      React.createElement('path', {
        d:
          'M14.4407 9.58045C14.4649 10.2792 14.1625 10.555 13.7781 10.5684C13.3937 10.5817 13.0729 10.3275 13.0486 9.62879C13.0243 8.93005 13.3268 8.65422 13.7112 8.64087C14.0956 8.62753 14.4164 8.88172 14.4407 9.58045Z',
        fill: '#017178',
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
      ...
      React.createElement('path', {
        ...
        clipRule: 'evenodd',
        d:
          'M12.3339 10.8945C12.1998 10.9119 12.1053 11.0348 12.1228 11.1689C12.1452 11.3405 12.0078 11.539 11.76 11.5713C11.6411 11.5868 11.5319 11.557 11.4508 11.5014C11.3393 11.425 11.1869 11.4535 11.1104 11.565C11.034 11.6765 11.0625 11.8289 11.174 11.9054C11.3555 12.0297 11.586 12.0878 11.8233 12.0569C12.2947 11.9954 12.6712 11.5878 12.6083 11.1056C12.5908 10.9715 12.468 10.877 12.3339 10.8945Z',
        fill: '#017178',
      }),
      React.createElement('path', {
        d:
          'M9.50991 12.781C9.67816 11.447 8.51926 10.3246 7.21792 10.5612C6.15761 10.7539 5.45717 11.7854 5.65344 12.8651L6.32848 16.5785C6.4664 17.3372 7.1822 17.8424 7.92727 17.7069C8.51353 17.6004 8.9626 17.1204 9.0384 16.5195L9.50991 12.781Z',
        fill: '#9A6AFF',
      }),
      React.createElement('path', {
        d:
          'M4.93123 13.9946C4.62613 12.6768 3.04713 12.1326 1.80838 12.9183C0.799086 13.5584 0.455077 14.825 1.04002 15.7472L3.05191 18.9192C3.46294 19.5673 4.37109 19.7279 5.08032 19.2781C5.63839 18.9241 5.92368 18.2814 5.78623 17.6877L4.93123 13.9946Z',
        fill: '#9A6AFF',
      }),
      React.createElement('path', {
        d:
          'M12.3621 17.3922C13.4422 19.6768 11.9781 22.2858 9.25833 23.5716C6.53859 24.8574 3.59314 24.333 2.5131 22.0485C1.43306 19.764 2.89716 17.1549 5.6169 15.8691C8.33664 14.5833 11.2821 15.1077 12.3621 17.3922Z',
        fill: '#9A6AFF',
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
      ...
      React.createElement('path', {
        ...
        clipRule: 'evenodd',
        d:
          'M8.75939 18.7345C8.86973 18.6564 9.02253 18.6825 9.10068 18.7928C9.45793 19.2972 9.2815 19.9886 8.77528 20.3471C8.66494 20.4253 8.51213 20.3992 8.43398 20.2889C8.35583 20.1785 8.38193 20.0257 8.49227 19.9476C8.8145 19.7193 8.87726 19.3246 8.7011 19.0758C8.62294 18.9655 8.64904 18.8127 8.75939 18.7345Z',
        fill: '#452A7A',
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
        clipRule: 'evenodd',
        d:
          'M8.75936 18.7345C8.86971 18.6563 9.02251 18.6824 9.10066 18.7928C9.27683 19.0415 9.67007 19.1133 9.9923 18.8851C10.1026 18.807 10.2554 18.8331 10.3336 18.9434C10.4117 19.0537 10.3856 19.2065 10.2753 19.2847C9.76908 19.6432 9.05832 19.5802 8.70107 19.0758C8.62292 18.9654 8.64902 18.8126 8.75936 18.7345Z',
        fill: '#452A7A',
      }),
      React.createElement('path', {
        d:
          'M7.26609 18.6401C7.75355 19.1413 7.7149 19.5488 7.43915 19.8169C7.16341 20.0851 6.755 20.1124 6.26755 19.6112C5.7801 19.11 5.81875 18.7025 6.09449 18.4343C6.37023 18.1662 6.77864 18.1389 7.26609 18.6401Z',
        fill: '#452A7A',
      }),
      React.createElement('path', {
        d:
          'M10.0286 16.8059C10.429 17.3791 10.3252 17.775 10.0099 17.9953C9.69452 18.2156 9.28705 18.1767 8.88668 17.6036C8.48632 17.0304 8.5901 16.6344 8.90543 16.4142C9.22077 16.1939 9.62825 16.2327 10.0286 16.8059Z',
        fill: '#452A7A',
      }),
      React.createElement('path', {
        d:
          'M15.821 11.1076C15.5183 9.7976 16.5573 8.56337 17.876 8.66668C18.9503 8.75086 19.7518 9.70595 19.6661 10.7999L19.3713 14.5627C19.3111 15.3315 18.6502 15.9067 17.8953 15.8475C17.3012 15.801 16.8058 15.3691 16.6694 14.7789L15.821 11.1076Z',
        fill: '#FFC700',
      }),
      React.createElement('path', {
        d:
          'M20.4641 11.4595C20.469 10.121 21.7611 9.16422 23.0195 9.56738C24.0448 9.89586 24.6059 11.0053 24.2727 12.0453L23.1267 15.6224C22.8925 16.3532 22.1187 16.7586 21.3982 16.5277C20.8313 16.3461 20.4482 15.8139 20.4504 15.2108L20.4641 11.4595Z',
        fill: '#FFC700',
      }),
      React.createElement('path', {
        d:
          'M13.6364 16.264C13.1079 18.7351 15.1302 20.9398 18.072 21.569C21.0138 22.1983 23.7611 21.0137 24.2897 18.5427C24.8182 16.0716 22.7959 13.8669 19.854 13.2376C16.9122 12.6084 14.1649 13.793 13.6364 16.264Z',
        fill: '#FFC700',
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
      ...
      React.createElement('path', {
        ...
        clipRule: 'evenodd',
        d:
          'M18.7679 17.3275C18.6381 17.2897 18.5022 17.3642 18.4643 17.494C18.379 17.7867 18.0308 17.983 17.6517 17.8725C17.5219 17.8347 17.386 17.9092 17.3482 18.039C17.3103 18.1689 17.3849 18.3048 17.5147 18.3426C18.1103 18.5162 18.7615 18.2245 18.9344 17.631C18.9723 17.5012 18.8977 17.3653 18.7679 17.3275Z',
        fill: '#AE5714',
      }),
      React.createElement('path', {
        d:
          'M17.78 16.2187C17.6338 16.9024 17.2734 17.0965 16.8973 17.016C16.5212 16.9356 16.2717 16.6111 16.4179 15.9274C16.5642 15.2437 16.9245 15.0496 17.3007 15.13C17.6768 15.2105 17.9263 15.535 17.78 16.2187Z',
        fill: '#AE5714',
      }),
      React.createElement('path', {
        d:
          'M21.344 17.3356C21.0937 17.9884 20.7077 18.1244 20.3485 17.9867C19.9894 17.849 19.7931 17.4897 20.0434 16.8369C20.2937 16.1841 20.6798 16.0482 21.039 16.1859C21.3981 16.3236 21.5943 16.6828 21.344 17.3356Z',
        fill: '#AE5714',
      }),
      React.createElement('path', {
        fillRule: 'evenodd',
...
const Icon$B = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M10.0002 7.33L15.0002 14H3.00018L8.00018 7.33V2H10.0002V7.33ZM12.9602 0H5.04018C4.62018 0 4.39018 0.48 4.65018 0.81L6.00018 2.5V6.67L0.200175 14.4C-0.289825 15.06 0.180175 16 1.00018 16H17.0002C17.8202 16 18.2902 15.06 17.8002 14.4L12.0002 6.67V2.5L13.3502 0.81C13.6102 0.48 13.3802 0 12.9602 0Z',
    })
  )
}
...
const Icon$z = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M39.0623 18.9777C39.3983 19.3138 39.4447 19.8426 39.1721 20.232C34.1862 27.3557 28.0207 33.576 20.9413 38.6248L20.3823 39.0235C19.9723 39.3159 19.4111 39.2692 19.055 38.9132L16.5383 36.3964C18.024 34.858 18.0077 32.4065 16.4893 30.8881C14.971 29.3698 12.5194 29.3535 10.981 30.8392L8.66608 28.5242C8.22585 28.084 8.28655 27.3538 8.79343 26.9923L9.35284 26.5933C16.261 21.6665 22.2775 15.5966 27.1429 8.64507C27.4837 8.15815 28.1816 8.09702 28.6019 8.51729L30.958 10.8734C29.4778 12.4121 29.496 14.8595 31.0125 16.3759C32.5289 17.8924 34.9762 17.9105 36.515 16.4304L39.0623 18.9777Z',
      fill: '#DBCDF9',
    }),
    React.createElement('path', {
      d:
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M23.8664 12.8716L24.4172 13.4223C24.6605 13.6657 24.6605 14.0602 24.4172 14.3035C24.1738 14.5469 23.7793 14.5469 23.536 14.3035L22.9852 13.7528C22.7419 13.5094 22.7419 13.1149 22.9852 12.8716C23.2285 12.6282 23.6231 12.6282 23.8664 12.8716Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M26.1799 15.1841L26.7306 15.7348C26.974 15.9782 26.974 16.3727 26.7306 16.616C26.4873 16.8594 26.0928 16.8594 25.8494 16.616L25.2987 16.0653C25.0553 15.8219 25.0553 15.4274 25.2987 15.1841C25.542 14.9407 25.9365 14.9407 26.1799 15.1841Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M29.0441 18.9295C28.8008 19.1729 28.4062 19.1728 28.1629 18.9295L27.502 18.2686C27.2587 18.0253 27.2587 17.6307 27.502 17.3874C27.7453 17.144 28.1399 17.144 28.3832 17.3874L29.0441 18.0483C29.2875 18.2916 29.2875 18.6862 29.0441 18.9295Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M31.3576 21.243C31.1143 21.4863 30.7197 21.4863 30.4764 21.243L29.8155 20.5821C29.5721 20.3387 29.5721 19.9442 29.8155 19.7009C30.0588 19.4575 30.4533 19.4575 30.6967 19.7009L31.3576 20.3618C31.6009 20.6051 31.6009 20.9996 31.3576 21.243Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M33.009 22.0141L33.5597 22.5649C33.8031 22.8082 33.8031 23.2028 33.5597 23.4461C33.3164 23.6895 32.9219 23.6895 32.6785 23.4461L32.1278 22.8953C31.8844 22.652 31.8844 22.2575 32.1278 22.0141C32.3711 21.7708 32.7656 21.7708 33.009 22.0141Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M35.3225 24.3266L35.8732 24.8774C36.1166 25.1207 36.1166 25.5153 35.8732 25.7586C35.6299 26.002 35.2354 26.002 34.992 25.7586L34.4412 25.2078C34.1979 24.9645 34.1979 24.57 34.4412 24.3266C34.6846 24.0833 35.0791 24.0833 35.3225 24.3266Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M20.6437 22.5266C19.9743 21.8573 19.9743 20.772 20.6437 20.1027C21.4022 19.3442 22.6632 19.4609 23.2695 20.3458L24.7964 22.5738C26.1291 22.1463 27.5433 22.2031 28.4805 23.1402C29.3229 23.9827 29.4507 25.2241 29.1652 26.4073C28.8764 27.6037 28.1461 28.8641 27.0722 29.9379C25.9984 31.0117 24.7381 31.742 23.5416 32.0308C22.3584 32.3164 21.117 32.1886 20.2745 31.3461C19.3428 30.4144 19.2815 29.0108 19.7006 27.6858L17.4629 26.1524C16.5781 25.546 16.4614 24.285 17.2199 23.5265C17.8892 22.8572 18.9745 22.8572 19.6438 23.5265L21.1943 25.077C21.3478 24.897 21.5107 24.7205 21.6828 24.5485C21.8489 24.3823 22.0193 24.2247 22.1928 24.0758L20.6437 22.5266Z',
      fill: '#633001',
    }),
    React.createElement('ellipse', {
      rx: '0.749452',
...
const Icon$x = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M16.8196 4.04526C17.2184 2.78478 16.2774 1.5 14.9553 1.5C13.8754 1.5 13 2.37543 13 3.45534L13 7.25679C13 8.01243 13.6126 8.625 14.3682 8.625C14.9648 8.625 15.4927 8.2384 15.6727 7.66958L16.8196 4.04526Z',
      fill: '#FFD800',
    }),
    React.createElement('path', {
      d:
        'M8.05539 4.04526C7.65652 2.78478 8.59753 1.5 9.91962 1.5C10.9995 1.5 11.875 2.37543 11.875 3.45534L11.875 7.25679C11.875 8.01243 11.2624 8.625 10.5067 8.625C9.91013 8.625 9.3823 8.2384 9.2023 7.66958L8.05539 4.04526Z',
      fill: '#FFD800',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M8.13603 7.98393C8.40807 8.2437 8.418 8.67482 8.15822 8.94685L8.04567 9.06471C7.79436 9.32787 7.65414 9.67776 7.65414 10.0416L7.65414 10.2898C7.65414 10.6659 7.34921 10.9708 6.97306 10.9708C6.59692 10.9708 6.29199 10.6659 6.29199 10.2898L6.29199 10.0416C6.29199 9.32735 6.56725 8.64055 7.06056 8.12398L7.17311 8.00611C7.43289 7.73408 7.864 7.72415 8.13603 7.98393Z',
      fill: '#FEED8D',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
    ...
    React.createElement('path', {
      ...
      clipRule: 'evenodd',
      d:
        'M12.789 9.61642C12.789 9.0473 13.2462 8.58594 13.8102 8.58594C14.4493 8.58594 14.9313 9.17163 14.814 9.80558L14.5186 11.4019C15.2601 11.7867 15.832 12.412 15.832 13.2088C15.832 13.9251 15.3629 14.5072 14.7441 14.8888C14.1184 15.2747 13.2798 15.5 12.375 15.5C11.4702 15.5 10.6316 15.2747 10.0059 14.8888C9.38712 14.5072 8.91797 13.9251 8.91797 13.2088C8.91797 12.4166 9.48346 11.7938 10.2182 11.4087L9.92155 9.80559C9.80423 9.17163 10.2863 8.58594 10.9254 8.58594C11.4894 8.58594 11.9466 9.04731 11.9466 9.61642L11.9466 10.9347C12.087 10.9235 12.23 10.9177 12.375 10.9177C12.515 10.9177 12.6532 10.9231 12.789 10.9336V9.61642Z',
      fill: '#FFAF00',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
...
const Icon$r = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M12 4C7 4 2.73 7.11 1 11.5C2.73 15.89 7 19 12 19C17 19 21.27 15.89 23 11.5C21.27 7.11 17 4 12 4ZM12 16.5C9.24 16.5 7 14.26 7 11.5C7 8.74 9.24 6.5 12 6.5C14.76 6.5 17 8.74 17 11.5C17 14.26 14.76 16.5 12 16.5ZM12 8.5C10.34 8.5 9 9.84 9 11.5C9 13.16 10.34 14.5 12 14.5C13.66 14.5 15 13.16 15 11.5C15 9.84 13.66 8.5 12 8.5Z',
    })
  )
}
...
const Icon$o = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M4.47 20.9999H19.53C21.07 20.9999 22.03 19.3299 21.26 17.9999L13.73 4.98993C12.96 3.65993 11.04 3.65993 10.27 4.98993L2.74 17.9999C1.97 19.3299 2.93 20.9999 4.47 20.9999ZM12 13.9999C11.45 13.9999 11 13.5499 11 12.9999V10.9999C11 10.4499 11.45 9.99993 12 9.99993C12.55 9.99993 13 10.4499 13 10.9999V12.9999C13 13.5499 12.55 13.9999 12 13.9999ZM13 17.9999H11V15.9999H13V17.9999Z',
    })
  )
}
...
const Icon$n = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M17.65 6.35C16.02 4.72 13.71 3.78 11.17 4.04C7.50002 4.41 4.48002 7.39 4.07002 11.06C3.52002 15.91 7.27002 20 12 20C15.19 20 17.93 18.13 19.21 15.44C19.53 14.77 19.05 14 18.31 14C17.94 14 17.59 14.2 17.43 14.53C16.3 16.96 13.59 18.5 10.63 17.84C8.41002 17.35 6.62002 15.54 6.15002 13.32C5.31002 9.44 8.26002 6 12 6C13.66 6 15.14 6.69 16.22 7.78L14.71 9.29C14.08 9.92 14.52 11 15.41 11H19C19.55 11 20 10.55 20 10V6.41C20 5.52 18.92 5.07 18.29 5.7L17.65 6.35Z',
    })
  )
}
...
const ExpandableButton = function (_a) {
  ...
  return React.createElement(
    ...
    children,
    expanded
      ? React.createElement(Icon$16, { color: 'invertedContrast' })
      : React.createElement(Icon$19, { color: 'invertedContrast' })
  )
}
...
const getThemeColor = function (_a) {
  const { theme } = _a
  const _b = _a.variant
  const variant = _b === void 0 ? variants$2.INFO : _b
  switch (variant) {
...
const StyledInput$1 = styled(Input$1)(
  templateObject_2$m ||
...
const BalanceInput = function (_a) {
  ...
  const _c = _a.isWarning
  const isWarning = _c === void 0 ? false : _c
  const props = __rest(_a, ['value', 'placeholder', 'onChange', 'currencyValue', 'inputProps', 'isWarning'])
  return React.createElement(
    StyledBalanceInput,
    { isWarning, ...props },
    React.createElement(StyledInput$1, { type: 'number', value, onChange, placeholder, ...inputProps }),
    currencyValue &&
...
const DefaultSeparator = React.createElement(Icon$17, { color: 'currentColor', width: '24px' })
const Breadcrumbs = function (_a) {
  const _b = _a.separator
  const separator = _b === void 0 ? DefaultSeparator : _b
  const { children } = _a
  const validItems = Children.toArray(children).filter(function (child) {
...
const ButtonMenu$1 = function (_a) {
  ...
  const _c = _a.scale
  const scale = _c === void 0 ? scales$7.MD : _c
  const _d = _a.variant
  const variant = _d === void 0 ? variants$3.PRIMARY : _d
...
const ButtonMenuItem = function (_a) {
  ...
  const _c = _a.variant
  const variant = _c === void 0 ? variants$3.PRIMARY : _c
  const { as } = _a
  const props = __rest(_a, ['isActive', 'variant', 'as'])
  if (!isActive) {
    return React.createElement(InactiveButton, { forwardedAs: as, variant: 'tertiary', ...props })
  }
  return React.createElement(Button, { as, variant, ...props })
}
...
const Card = function (_a) {
  ...
  return React.createElement(StyledCard, { ...props }, ribbon, children)
}
...
const Dropdown = function (_a) {
  ...
  const { children } = _a
  return React.createElement(Container$4, null, target, React.createElement(DropdownContent, { position }, children))
}
...
const BackgroundImage = function (_a) {
  const { src } = _a
  const otherProps = __rest(_a, ['src'])
  ...
  return React.createElement(Wrapper$3, { ref: imgRef, ...otherProps })
}
...
const Image = function (_a) {
  const { src } = _a
  const { alt } = _a
  const otherProps = __rest(_a, ['src', 'alt'])
  const imgRef = useRef(null)
  ...
  return React.createElement(
    Wrapper$3,
    { ref: imgRef, ...otherProps },
    isLoaded ? React.createElement(StyledImage, { src, alt }) : React.createElement(Placeholder, null)
  )
}
let templateObject_1$z
let templateObject_2$i

const GridLayout$1 = styled.div(
  templateObject_1$y ||
...
const StyledLink$1 = styled(Text)(
  templateObject_1$w ||
...
const Link = function (_a) {
  ...
  const internalProps = external ? getExternalLinkProps() : {}
  return React.createElement(StyledLink$1, { as: 'a', bold: true, ...internalProps, ...props })
}
Link.defaultProps = {
  color: 'primary',
}
...
const PancakeInput = styled.input(
  templateObject_2$g ||
...
const PancakeLabel = styled.label(
  templateObject_3$9 ||
...
const PancakeToggle = function (_a) {
  ...
  return React.createElement(
    PancakeStack,
    { scale },
    React.createElement(PancakeInput, { id: props.id || 'pancake-toggle', scale, type: 'checkbox', checked, ...props }),
    React.createElement(
      PancakeLabel,
...
const getBaseThumbStyles = function (_a) {
  ...
  return `\n  -webkit-appearance: none;\n  background-image: url(${
    ...
    disabled ? 'scale(1) translate(-2px, -2px)' : 'scale(1.1) translate(-3px, -3px)'
  };\n  }\n`
}
...
const Slider = function (_a) {
  ...
  return React.createElement(
    ...
    React.createElement(BunnyButt, { disabled }),
    React.createElement(
      BunnySlider,
      null,
      React.createElement(BarBackground, { disabled }),
      React.createElement(BarProgress, { style: { width: progressWidth }, disabled }),
...
const Skeleton = function (_a) {
  ...
  if (animation$1 === animation.WAVES) {
    return React.createElement(Waves, { variant: variant$1, ...props })
  }
  return React.createElement(Pulse, { variant: variant$1, ...props })
}
let templateObject_1$p
...
const Icon$m = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M159.97 178.737L175.437 178.709C178.284 178.704 178.523 174.429 177.474 164.815C176.82 158.816 173.457 154.101 171.27 155.477L159.942 163.875L159.97 178.737Z',
      fill: '#464649',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
...
const RotatingPancakeIcon = styled(Icon$l)(
  templateObject_4$4 ||
...
const FloatingPanIcon = styled(Icon$m)(
  templateObject_5$2 ||
...
const Step = function (_a) {
  ...
  return React.createElement(
    ...
    React.createElement(
      Wrapper$2,
      null,
      React.createElement(StepNumber, { status }, index + 1),
      index < numberOfSteps - 1 && React.createElement(Connector, { status })
    ),
...
const Tab = function (_a) {
  ...
  return React.createElement(
    StyledTab,
    { onClick, bgColor: isActive ? 'textSubtle' : 'input', color: isActive ? 'backgroundAlt' : 'textSubtle' },
...
const getScale = function (property) {
  return function (_a) {
    const _b = _a.scale
    const scale = _b === void 0 ? scales$5.MD : _b
...
const Toggle = function (_a) {
  ...
  return React.createElement(
    ...
    React.createElement(Input, { checked, scale, ...props, type: 'checkbox' }),
    React.createElement(Handle, { scale })
  )
}
Toggle.defaultProps = {
  scale: scales.MD,
...
const useTooltip = function (content, placement, trigger, arrowPadding, tooltipPadding, tooltipOffset) {
  if (placement === void 0) {
    placement = 'auto'
  }
  if (trigger === void 0) {
  ...
  const targetElement = _a[0]
  const setTargetElement = _a[1]
  const _b = useState(null)
  const tooltipElement = _b[0]
  const setTooltipElement = _b[1]
  const _c = useState(null)
  const arrowElement = _c[0]
  const setArrowElement = _c[1]
  const _d = useState(false)
  const visible = _d[0]
  const setVisible = _d[1]
  const hideTooltip = useCallback(function (e) {
    e.stopPropagation()
    e.preventDefault()
    setVisible(false)
  }, [])
  const showTooltip = useCallback(function (e) {
    e.stopPropagation()
    e.preventDefault()
    setVisible(true)
  }, [])
  ...
  const _e = usePopper(targetElement, tooltipElement, {
    placement,
    modifiers: [
      {
        name: 'arrow',
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ModalTitle,
        null,
        onBack && React.createElement(ModalBackButton, { onBack }),
        React.createElement(Heading, null, title)
      ),
      !hideCloseButton && React.createElement(ModalCloseButton, { onDismiss })
    ),
...
const ModalProvider = function (_a) {
  ...
  const _d = useState(true)
  const closeOnOverlayClick = _d[0]
  const setCloseOnOverlayClick = _d[1]
  const handlePresent = function (node) {
    setModalNode(node)
    setIsOpen(true)
  }
...
const useModal = function (modal, closeOnOverlayClick) {
  if (closeOnOverlayClick === void 0) {
    closeOnOverlayClick = true
  }
  const _a = useContext(Context)
  const { onPresent } = _a
  const { onDismiss } = _a
...
const Icon$k = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M13.7803 2.71967C14.0732 3.01256 14.0732 3.48744 13.7803 3.78033L12.8107 4.75L14.0307 5.96999H20C21.1 5.96999 22 6.86999 22 7.96999V12.73C21.28 12.25 20.43 11.97 19.5 11.97C17.19 11.97 15.3 13.73 15.05 15.97H11.91C11.96 15.64 12 15.31 12 14.97C12 13.43 11.41 12.03 10.46 10.97H11C12.1 10.97 13 10.07 13 8.96999V7.06068L11.75 5.81066L10.7803 6.78033C10.4874 7.07322 10.0126 7.07322 9.71967 6.78033C9.42678 6.48744 9.42678 6.01256 9.71967 5.71967L12.7197 2.71967C13.0126 2.42678 13.4874 2.42678 13.7803 2.71967Z',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M11 15C11 17.7614 8.76142 20 6 20C3.23858 20 1 17.7614 1 15C1 12.2386 3.23858 10 6 10C8.76142 10 11 12.2386 11 15ZM9 15C9 16.6569 7.65685 18 6 18C4.34315 18 3 16.6569 3 15C3 13.3431 4.34315 12 6 12C7.65685 12 9 13.3431 9 15Z',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M19.5 12.97C17.57 12.97 16 14.54 16 16.47C16 18.4 17.57 19.97 19.5 19.97C21.43 19.97 23 18.4 23 16.47C23 14.54 21.43 12.97 19.5 12.97ZM19.5 17.97C18.67 17.97 18 17.3 18 16.47C18 15.64 18.67 14.97 19.5 14.97C20.33 14.97 21 15.64 21 16.47C21 17.3 20.33 17.97 19.5 17.97Z',
    }),
    React.createElement('path', {
      d:
        'M9 8.96997H4C3.45 8.96997 3 8.52997 3 7.96997C3 7.41997 3.45 6.96997 4 6.96997H7C8.1 6.96997 9 7.86997 9 8.96997Z',
    })
  )
}
...
const Icon$i = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M4 18H20C20.55 18 21 17.55 21 17C21 16.45 20.55 16 20 16H4C3.45 16 3 16.45 3 17C3 17.55 3.45 18 4 18ZM4 13H20C20.55 13 21 12.55 21 12C21 11.45 20.55 11 20 11H4C3.45 11 3 11.45 3 12C3 12.55 3.45 13 4 13ZM3 7C3 7.55 3.45 8 4 8H20C20.55 8 21 7.55 21 7C21 6.45 20.55 6 20 6H4C3.45 6 3 6.45 3 7Z',
    })
  )
}
...
const Icon$h = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M4 18H15C15.55 18 16 17.55 16 17C16 16.45 15.55 16 15 16H4C3.45 16 3 16.45 3 17C3 17.55 3.45 18 4 18ZM4 13H12C12.55 13 13 12.55 13 12C13 11.45 12.55 11 12 11H4C3.45 11 3 11.45 3 12C3 12.55 3.45 13 4 13ZM3 7C3 7.55 3.45 8 4 8H15C15.55 8 16 7.55 16 7C16 6.45 15.55 6 15 6H4C3.45 6 3 6.45 3 7ZM20.3 14.88L17.42 12L20.3 9.12C20.69 8.73 20.69 8.1 20.3 7.71C19.91 7.32 19.28 7.32 18.89 7.71L15.3 11.3C14.91 11.69 14.91 12.32 15.3 12.71L18.89 16.3C19.28 16.69 19.91 16.69 20.3 16.3C20.68 15.91 20.69 15.27 20.3 14.88Z',
    })
  )
}
...
const Icon$g = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M9.99998 19V14H14V19C14 19.55 14.45 20 15 20H18C18.55 20 19 19.55 19 19V12H20.7C21.16 12 21.38 11.43 21.03 11.13L12.67 3.59997C12.29 3.25997 11.71 3.25997 11.33 3.59997L2.96998 11.13C2.62998 11.43 2.83998 12 3.29998 12H4.99998V19C4.99998 19.55 5.44998 20 5.99998 20H8.99998C9.54998 20 9.99998 19.55 9.99998 19Z',
    })
  )
}
...
const logo1png = '67b9661867369042.png'

const Logo$2 = function (_a) {
  _a.isDark
  __rest(_a, ['isDark'])
  return React.createElement(
    'div',
    { style: { display: 'flex', alignItems: 'center' } },
    React.createElement('img', { src: logo1png, style: { width: '36px', marginRight: '8px' } }),
    React.createElement('div', { style: { color: '#ffffff' } }, 'SilkSwap')
  )
  // return (
...
const LogoWithText = React.memo(Logo$2, function (prev, next) {
...
const Icon$a = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M12.8533 3.39627C12.4634 2.75821 11.5366 2.75821 11.1467 3.39627L7.42977 9.47855C7.02256 10.1449 7.50213 11 8.28306 11H15.7169C16.4979 11 16.9774 10.1449 16.5702 9.47855L12.8533 3.39627ZM12 5.84L13.93 9H10.06L12 5.84ZM17.5 13C15.01 13 13 15.01 13 17.5C13 19.99 15.01 22 17.5 22C19.99 22 22 19.99 22 17.5C22 15.01 19.99 13 17.5 13ZM17.5 20C16.12 20 15 18.88 15 17.5C15 16.12 16.12 15 17.5 15C18.88 15 20 16.12 20 17.5C20 18.88 18.88 20 17.5 20ZM3 19.5C3 20.6046 3.89543 21.5 5 21.5H9C10.1046 21.5 11 20.6046 11 19.5V15.5C11 14.3954 10.1046 13.5 9 13.5H5C3.89543 13.5 3 14.3954 3 15.5V19.5ZM5 15.5H9V19.5H5V15.5Z',
    })
  )
}
...
const Icon$9 = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M7.5 13C7.5 11.8954 8.39543 11 9.5 11H12.5C13.6046 11 14.5 11.8954 14.5 13V15C14.5 16.1046 13.6046 17 12.5 17H9.5C8.39543 17 7.5 16.1046 7.5 15V13Z',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M9.5 2C8.39543 2 7.5 2.89543 7.5 4V6.49482C7.5 6.93167 7.2113 7.30895 6.81834 7.49981C5.15004 8.31009 4 10.0207 4 12V17C4 19.2091 5.79086 21 8 21H14C16.2091 21 18 19.2091 18 17V12C18 11.4175 17.9004 10.8583 17.7173 10.3385L17.7892 10.297C19.4786 9.32167 20.0574 7.16153 19.082 5.47221C18.1552 3.86682 16.1534 3.25957 14.5 4.05146V4C14.5 2.89543 13.6046 2 12.5 2H9.5ZM9.5 6.25V4H12.5V6.25H9.5ZM9.22663 7.75C8.89473 8.46917 8.30318 9.00205 7.69211 9.29884C6.68638 9.78731 6 10.8154 6 12V17C6 18.1046 6.89543 19 8 19H14C15.1046 19 16 18.1046 16 17V12C16 10.8154 15.3136 9.78731 14.3079 9.29884C13.6968 9.00205 13.1053 8.46917 12.7734 7.75H9.22663ZM14.5 6.3226V6.49482C14.5 6.93167 14.7887 7.30895 15.1817 7.49981C15.7529 7.77726 16.2634 8.16029 16.6878 8.62352L16.7892 8.56495C17.522 8.1419 17.773 7.20495 17.35 6.47221C16.9346 5.75269 16.0213 5.49542 15.2914 5.89229L14.5 6.3226Z',
    })
  )
}
...
const Icon$2 = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M8.65854 19C15.4488 19 19.1659 13.2338 19.1659 8.23717C19.1659 8.07728 19.1659 7.91739 19.1561 7.7475C19.878 7.21785 20.5024 6.5483 21 5.78881C20.3366 6.08861 19.6244 6.28847 18.8732 6.38841C19.6341 5.91872 20.2195 5.17921 20.5024 4.28981C19.7902 4.72951 19 5.03931 18.1512 5.20919C17.478 4.45969 16.522 4 15.4585 4C13.4195 4 11.761 5.69887 11.761 7.78747C11.761 8.08728 11.8 8.36709 11.8585 8.6469C8.79512 8.497 6.07317 6.97801 4.24878 4.68954C3.92683 5.25916 3.75122 5.90873 3.75122 6.59827C3.75122 7.90739 4.40488 9.06662 5.39024 9.74617C4.78537 9.72618 4.21951 9.5563 3.72195 9.27648C3.72195 9.28648 3.72195 9.30646 3.72195 9.32645C3.72195 11.1552 5 12.6942 6.67805 13.034C6.36585 13.1239 6.0439 13.1639 5.70244 13.1639C5.46829 13.1639 5.23415 13.1439 5.00976 13.0939C5.47805 14.6029 6.8439 15.6922 8.46341 15.7222C7.19512 16.7415 5.60488 17.3411 3.87805 17.3411C3.58537 17.3411 3.28293 17.3311 3 17.2911C4.62927 18.3704 6.57073 19 8.65854 19Z',
    })
  )
}
...
const Logo = function (_a) {
  ...
  const innerLogo = React.createElement(
    React.Fragment,
    null,
    React.createElement(Icon$X, { className: 'mobile-icon' }),
    React.createElement(LogoWithText, { className: 'desktop-icon', isDark })
  )
  return React.createElement(
    Flex,
    null,
    React.createElement(
      ...
      isPushed
        ? React.createElement(Icon$h, { width: '24px', color: 'textSubtle' })
        : React.createElement(Icon$i, { width: '24px', color: 'textSubtle' })
    ),
    isAbsoluteUrl
      ? React.createElement(StyledLink, { as: 'a', href, 'aria-label': 'Pancake home page' }, innerLogo)
      : React.createElement(StyledLink, { to: href, 'aria-label': 'Pancake home page' }, innerLogo)
  )
}
const Logo$1 = React.memo(Logo, function (prev, next) {
...
const LinkLabelMemo = React.memo(LinkLabel, function (prev, next) {
...
const Accordion = function (_a) {
  ...
  const { className } = _a
  const { isActive } = _a
  const _c = useState(initialOpenState)
  const isOpen = _c[0]
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      icon,
      React.createElement(LinkLabelMemo, { isPushed }, label),
      isOpen ? React.createElement(Icon$1l, null) : React.createElement(Icon$1m, null)
    ),
    React.createElement(
      AccordionContent,
      { isOpen, isPushed, maxHeight: React.Children.count(children) * MENU_ENTRY_HEIGHT },
      children
    )
  )
}
const Accordion$1 = React.memo(Accordion, function (prev, next) {
...
const MenuLink = function (_a) {
  ...
  return React.createElement(Tag, { ...props, ...otherProps })
}
...
const PanelBody = function (_a) {
  ...
  return React.createElement(
    ...
    links.map(function (entry) {
      const Icon = Icons$1[entry.icon]
      const iconElement = React.createElement(Icon, { width: '24px', mr: '8px' })
            ...
            entry.items.map(function (item) {
              return React.createElement(
                ...
                React.createElement(
                  MenuLink,
                  { href: item.href },
                  React.createElement(LinkLabelMemo, { isPushed }, item.label),
                  item.status &&
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          iconElement,
          React.createElement(LinkLabelMemo, { isPushed }, entry.label),
          entry.status &&
...
const SocialLinks$1 = React.memo(SocialLinks, function () {
  return true
})
...
const PanelFooter = function (_a) {
  ...
  return React.createElement(
    Container,
    null,
    React.createElement(SocialEntry, null, React.createElement(SocialLinks$1, null))
  )
}
...
const Panel = function (props) {
  ...
  return React.createElement(
    StyledPanel,
    { isPushed, showMenu },
    React.createElement(PanelBody, { ...props }),
    React.createElement(PanelFooter, { ...props })
  )
}
...
const Icon$1 = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M53.4468 75.6443L53.5233 73.2462L52.8855 72.6849H43.1143L42.502 73.2462L42.5531 75.6443L34.3892 71.792L37.2465 74.1391L43.0378 78.1445H52.962L58.7533 74.1391L61.6107 71.792L53.4468 75.6443Z',
      fill: '#C0AC9D',
    }),
    React.createElement('path', {
      d:
        'M52.8346 67.5315L51.5845 66.6641H44.4156L43.1655 67.5315L42.5022 73.2462L43.1145 72.6849H52.8857L53.5235 73.2462L52.8346 67.5315Z',
      fill: '#161616',
    }),
    React.createElement('path', {
      d:
        'M78.8314 37.2998L80.9999 26.7377L77.7599 16.9155L52.8345 35.4119L62.4271 43.5247L75.9485 47.4791L78.9335 43.984L77.6323 43.04L79.7243 41.1521L78.1426 39.902L80.2091 38.3458L78.8314 37.2998Z',
      fill: '#763E1A',
    }),
    React.createElement('path', {
      d:
        'M15 26.7377L17.194 37.2998L15.7909 38.3458L17.8574 39.902L16.2756 41.1521L18.3676 43.04L17.0665 43.984L20.0514 47.4791L33.5984 43.5247L43.1655 35.4119L18.2656 16.9155L15 26.7377Z',
      fill: '#763E1A',
    }),
    React.createElement('path', {
    ...
    React.createElement('path', {
      d:
        'M51.9415 50.3617L52.8344 35.4115L56.7378 24.7729H39.262L43.1653 35.4115L44.0583 50.3617L44.3899 55.0559L44.4154 66.664H51.5843L51.6099 55.0559L51.9415 50.3617Z',
      fill: '#F5841F',
    })
  )
}
...
const Icon = function (props) {
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M96 48C96 21.4903 74.5097 0 48 0C21.4903 0 0 21.4903 0 48C0 74.5097 21.4903 96 48 96C74.5097 96 96 74.5097 96 48Z',
      fill: '#3389FB',
    }),
    React.createElement('path', {
      d:
...
const WalletCard = function (_a) {
  ...
  return React.createElement(
    Button,
    {
      ...
      style: { justifyContent: 'space-between', background: 'transparent', border: '1px solid #e6e6e6' },
      mb,
...
const ConnectModal = function (_a) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Icon$10, { color: 'primary', mr: '6px' }),
...
const CopyToClipboard = function (_a) {
  ...
  return React.createElement(
    ...
    React.createElement(Tooltip, { isTooltipDisplayed }, 'Copied')
  )
}
...
const useWalletModal = function (login, logout, account) {
  const onPresentConnectModal = useModal(React.createElement(ConnectModal, { login }))[0]
  const onPresentAccountModal = useModal(React.createElement(AccountModal, { account: account || '', logout }))[0]
...
const UserBlock = function (_a) {
  ...
  return React.createElement(
    'div',
    { style: { display: 'flex' } },
    React.createElement(SlkBtn, null),
    account
      ? React.createElement(
          Button,
          {
...
const UserBlock$1 = React.memo(UserBlock, function (prevProps, nextProps) {
...
const Avatar = function (_a) {
  const { profile } = _a
  const _b = profile.username
  const username = _b === void 0 ? 'Bunny' : _b
  const { image } = profile
  const { profileLink } = profile
  const { noProfileLink } = profile
  const _c = profile.showPip
  const showPip = _c === void 0 ? false : _c
  const link = profile.username ? profileLink : noProfileLink
  const isExternal = link.startsWith('http')
  const ariaLabel = 'Link to profile'
  const icon = image
    ? React.createElement('img', { src: image, alt: 'profile avatar', height: '32px', width: '32px' })
    : React.createElement(Icon$O, { width: '32px', height: '32px' })
  if (isExternal) {
    return React.createElement(
      StyledAvatar,
      { title: username },
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        Flex,
        null,
        React.createElement(UserBlock$1, { account, login, logout, btns }),
        profile && React.createElement(Avatar, { profile })
      )
    ),
    React.createElement(
      BodyWrapper,
      ...
      React.createElement(Inner, { isPushed, showMenu }, children),
...
const ToastAction = function (_a) {
  const { action } = _a
  if (action.url.startsWith('http')) {
    return React.createElement(
      Button,
      { as: 'a', scale: 'sm', href: action.url, ...getExternalLinkProps() },
      action.text
    )
  }
      ...
      React.createElement(
        ...
        action
          ? React.createElement(
              ...
              React.createElement(ToastAction, { action })
            )
          : description
      )
    )
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      toasts.map(function (toast, index) {
        ...
        return React.createElement(Toast, { key: toast.id, toast, onRemove, ttl, style: { top: `${top}px`, zIndex } })
      })
    )
  )
}
...
const darkColors = {
  ...
  backgroundAlt: '#222323',
  contrast: '#FFFFFF',
  dropdown: '#1E1D20',
  // invertedContrast: "#191326",
  invertedContrast: '#eee',
  // input: "#483f5a",
  input: '#eee',
...
export {
  Icon$1p as AddIcon,
  Alert,
  Icon$1o as ArrowBackIcon,
  Icon$1n as ArrowDownIcon,
  Icon$1m as ArrowDropDownIcon,
  Icon$1l as ArrowDropUpIcon,
  Icon$1k as ArrowForwardIcon,
  Icon$1j as ArrowUpIcon,
  Icon$1i as AutoRenewIcon,
  BackgroundImage,
  BalanceInput,
  GridLayout$1 as BaseLayout,
  Icon$1h as BinanceIcon,
  Icon$1r as BlockIcon,
  Box,
  Breadcrumbs,
  Icon$1g as BunnyPlaceholderIcon,
  Button,
  ButtonMenu$1 as ButtonMenu,
  ButtonMenuItem,
  Icon$1d as CalculateIcon,
  Card,
  CardBody,
  CardFooter,
  CardHeader,
  CardRibbon,
  Icon$1e as CardViewIcon,
  Icon$1f as Cards,
  GridLayout as CardsLayout,
  Icon$1b as ChartIcon,
  Checkbox,
  Icon$1t as CheckmarkCircleIcon,
  Icon$1a as CheckmarkIcon,
  Icon$19 as ChevronDownIcon,
  Icon$18 as ChevronLeftIcon,
  Icon$17 as ChevronRightIcon,
  Icon$16 as ChevronUpIcon,
  Icon$1c as CircleOutlineIcon,
  Icon$15 as CloseIcon,
  Icon$14 as CogIcon,
  Icon$13 as CommunityIcon,
  ConnectorNames,
  Icon$12 as CopyIcon,
  Icon$11 as CrownIcon,
  Dropdown,
  Icon$1s as ErrorIcon,
  ExpandableButton,
  ExpandableLabel,
  FallingBunnies,
  Flex,
  ...
  Icon$1q as InfoIcon,
  Input$1 as Input,
  Icon$_ as LaurelLeftIcon,
  Icon$Z as LaurelRightIcon,
  Link,
  LinkExternal,
  Icon$Y as ListViewIcon,
  Icon$X as LogoIcon,
  Icon$W as LogoRoundIcon,
  Icon$V as MedalBronzeIcon,
  Icon$U as MedalGoldIcon,
  Icon$T as MedalPurpleIcon,
  Icon$S as MedalSilverIcon,
  Icon$R as MedalTealIcon,
  Menu,
  Icon$Q as MetamaskIcon,
  Icon$P as MinusIcon,
  Modal,
  ModalBackButton,
  ModalBody,
  ...
  ModalProvider,
  ModalTitle,
  Icon$O as NoProfileAvatarIcon,
  NotificationDot,
  Icon$N as OpenNewIcon,
  Icon$L as PancakeRoundIcon,
  PancakeToggle,
  Icon$M as PancakesIcon,
  Icon$J as PlayCircleOutlineIcon,
  Icon$K as PocketWatchIcon,
  Icon$I as PrizeIcon,
  Progress,
  Icon$F as ProgressBunny,
  Radio,
  Icon$n as RefreshIcon,
  Icon$H as RemoveIcon,
  ResetCSS,
  Icon$v as SearchIcon,
  Skeleton,
  Slider,
  Spinner,
  Step,
  Stepper,
  Svg,
  Icon$u as SwapVertIcon,
  Icon$t as SyncAltIcon,
  Tab,
  ButtonMenu as TabMenu,
  Tag,
  Icon$C as TeamPlayerIcon,
  Icon$B as TestnetIcon,
  Text,
  Icon$A as Ticket,
  Icon$z as TicketRound,
  Icon$y as TimerIcon,
  ToastContainer,
  Toggle,
  Icon$x as TrophyGoldIcon,
  Icon$w as TuneIcon,
  Icon$G as VerifiedIcon,
  Icon$s as VisibilityOff,
  Icon$r as VisibilityOn,
  Icon$q as VolumeOffIcon,
  Icon$p as VolumeUpIcon,
  Icon$E as WaitIcon,
  Icon$o as WarningIcon,
  Icon$D as Won,
